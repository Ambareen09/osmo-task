...
exports.ProofSpec = exports.NonExistenceProof = exports.LengthOpSDKType = exports.LengthOpAmino = exports.LengthOp = exports.LeafOp = exports.InnerSpec = exports.InnerOp = exports.HashOpSDKType = exports.HashOpAmino = exports.HashOp = exports.ExistenceProof = exports.CompressedNonExistenceProof = exports.CompressedExistenceProof = exports.CompressedBatchProof = exports.CompressedBatchEntry = exports.CommitmentProof = exports.BatchProof = exports.BatchEntry = void 0;
...
var HashOpAmino = HashOp;
exports.HashOpAmino = HashOpAmino;
...
var LengthOpAmino = LengthOp;
exports.LengthOpAmino = LengthOpAmino;
...
var ExistenceProof = {
  ...
  toAmino: function toAmino(message) {
    ...
    if (message.path) {
      obj.path = message.path.map(function (e) {
        return e ? InnerOp.toAmino(e) : undefined;
      });
    } else {
      obj.path = [];
    }
...
var LeafOp = {
  ...
  fromAmino: function fromAmino(object) {
    return {
      hash: (0, _helpers.isSet)(object.hash) ? hashOpFromJSON(object.hash) : 0,
      prehashKey: (0, _helpers.isSet)(object.prehash_key) ? hashOpFromJSON(object.prehash_key) : 0,
      prehashValue: (0, _helpers.isSet)(object.prehash_value) ? hashOpFromJSON(object.prehash_value) : 0,
      length: (0, _helpers.isSet)(object.length) ? lengthOpFromJSON(object.length) : 0,
...
var InnerSpec = {
  ...
  fromAmino: function fromAmino(object) {
    return {
      childOrder: Array.isArray(object === null || object === void 0 ? void 0 : object.child_order) ? object.child_order.map(function (e) {
        return e;
      }) : [],
  ...
  toAmino: function toAmino(message) {
    var obj = {};
    if (message.childOrder) {
      obj.child_order = message.childOrder.map(function (e) {
        return e;
      });
    } else {
      obj.child_order = [];
...
var BatchProof = {
  ...
  toAmino: function toAmino(message) {
    ...
    if (message.entries) {
      obj.entries = message.entries.map(function (e) {
        return e ? BatchEntry.toAmino(e) : undefined;
      });
    } else {
      obj.entries = [];
    }
...
var CompressedBatchProof = {
  ...
  fromAmino: function fromAmino(object) {
    return {
      entries: Array.isArray(object === null || object === void 0 ? void 0 : object.entries) ? object.entries.map(function (e) {
        return CompressedBatchEntry.fromAmino(e);
      }) : [],
      lookupInners: Array.isArray(object === null || object === void 0 ? void 0 : object.lookup_inners) ? object.lookup_inners.map(function (e) {
        return InnerOp.fromAmino(e);
      }) : []
    };
  },
  toAmino: function toAmino(message) {
    ...
    if (message.entries) {
      obj.entries = message.entries.map(function (e) {
        return e ? CompressedBatchEntry.toAmino(e) : undefined;
      });
    } else {
      obj.entries = [];
    }
    if (message.lookupInners) {
      obj.lookup_inners = message.lookupInners.map(function (e) {
        return e ? InnerOp.toAmino(e) : undefined;
      });
    } else {
      obj.lookup_inners = [];
