...
exports.Sdk_Msg_ToAmino = exports.Sdk_Msg_InterfaceDecoder = exports.Sdk_Msg_FromAmino = exports.MsgRevokeResponse = exports.MsgRevoke = exports.MsgGrantResponse = exports.MsgGrant = exports.MsgExecResponse = exports.MsgExec = exports.Cosmos_authzAuthorization_ToAmino = exports.Cosmos_authzAuthorization_InterfaceDecoder = exports.Cosmos_authzAuthorization_FromAmino = void 0;
var _authz = require("./authz");
var _any = require("../../../google/protobuf/any");
var _authz2 = require("../../bank/v1beta1/authz");
var _authz3 = require("../../staking/v1beta1/authz");
var _authz4 = require("../../../cosmwasm/wasm/v1/authz");
...
var MsgExec = {
  ...
  fromAmino: function fromAmino(object) {
    return {
      grantee: object.grantee,
      msgs: Array.isArray(object === null || object === void 0 ? void 0 : object.msgs) ? object.msgs.map(function (e) {
        return Sdk_MsgcosmosauthzAuthorization_FromAmino(e);
      }) : []
    };
  },
  toAmino: function toAmino(message) {
    ...
    if (message.msgs) {
      obj.msgs = message.msgs.map(function (e) {
        return e ? Sdk_MsgcosmosauthzAuthorization_ToAmino(e) : undefined;
      });
    } else {
      obj.msgs = [];
    }
...
var Sdk_Msg_InterfaceDecoder = function Sdk_Msg_InterfaceDecoder(input) {
  var reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
...
var Sdk_Msg_FromAmino = function Sdk_Msg_FromAmino(content) {
  return _any.Any.fromAmino(content);
};
exports.Sdk_Msg_FromAmino = Sdk_Msg_FromAmino;
var Sdk_Msg_ToAmino = function Sdk_Msg_ToAmino(content) {
  return _any.Any.toAmino(content);
};
exports.Sdk_Msg_ToAmino = Sdk_Msg_ToAmino;
var Cosmos_authzAuthorization_InterfaceDecoder = function Cosmos_authzAuthorization_InterfaceDecoder(input) {
  var reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
  var data = _any.Any.decode(reader, reader.uint32());
  switch (data.typeUrl) {
    case "/cosmos.authz.v1beta1.GenericAuthorization":
      return _authz.GenericAuthorization.decode(data.value);
    case "/cosmos.bank.v1beta1.SendAuthorization":
      return _authz2.SendAuthorization.decode(data.value);
    case "/cosmos.staking.v1beta1.StakeAuthorization":
      return _authz3.StakeAuthorization.decode(data.value);
    case "/cosmwasm.wasm.v1.ContractExecutionAuthorization":
      return _authz4.ContractExecutionAuthorization.decode(data.value);
    case "/cosmwasm.wasm.v1.ContractMigrationAuthorization":
      return _authz4.ContractMigrationAuthorization.decode(data.value);
    default:
      return data;
  }
};
exports.Cosmos_authzAuthorization_InterfaceDecoder = Cosmos_authzAuthorization_InterfaceDecoder;
var Cosmos_authzAuthorization_FromAmino = function Cosmos_authzAuthorization_FromAmino(content) {
  switch (content.type) {
    case "cosmos-sdk/GenericAuthorization":
      return _any.Any.fromPartial({
        typeUrl: "/cosmos.authz.v1beta1.GenericAuthorization",
        value: _authz.GenericAuthorization.encode(_authz.GenericAuthorization.fromPartial(content.value)).finish()
      });
    case "cosmos-sdk/SendAuthorization":
      return _any.Any.fromPartial({
        typeUrl: "/cosmos.bank.v1beta1.SendAuthorization",
        value: _authz2.SendAuthorization.encode(_authz2.SendAuthorization.fromPartial(content.value)).finish()
      });
    case "cosmos-sdk/StakeAuthorization":
      return _any.Any.fromPartial({
        typeUrl: "/cosmos.staking.v1beta1.StakeAuthorization",
        value: _authz3.StakeAuthorization.encode(_authz3.StakeAuthorization.fromPartial(content.value)).finish()
      });
    case "wasm/ContractExecutionAuthorization":
      return _any.Any.fromPartial({
        typeUrl: "/cosmwasm.wasm.v1.ContractExecutionAuthorization",
        value: _authz4.ContractExecutionAuthorization.encode(_authz4.ContractExecutionAuthorization.fromPartial(content.value)).finish()
      });
    case "wasm/ContractMigrationAuthorization":
      return _any.Any.fromPartial({
        typeUrl: "/cosmwasm.wasm.v1.ContractMigrationAuthorization",
        value: _authz4.ContractMigrationAuthorization.encode(_authz4.ContractMigrationAuthorization.fromPartial(content.value)).finish()
      });
    default:
      return _any.Any.fromAmino(content);
  }
...
var Cosmos_authzAuthorization_ToAmino = function Cosmos_authzAuthorization_ToAmino(content) {
  switch (content.typeUrl) {
    case "/cosmos.authz.v1beta1.GenericAuthorization":
      return {
        type: "cosmos-sdk/GenericAuthorization",
        value: _authz.GenericAuthorization.toAmino(_authz.GenericAuthorization.decode(content.value))
      };
    case "/cosmos.bank.v1beta1.SendAuthorization":
      return {
        type: "cosmos-sdk/SendAuthorization",
        value: _authz2.SendAuthorization.toAmino(_authz2.SendAuthorization.decode(content.value))
      };
    case "/cosmos.staking.v1beta1.StakeAuthorization":
      return {
        type: "cosmos-sdk/StakeAuthorization",
        value: _authz3.StakeAuthorization.toAmino(_authz3.StakeAuthorization.decode(content.value))
      };
    case "/cosmwasm.wasm.v1.ContractExecutionAuthorization":
      return {
        type: "wasm/ContractExecutionAuthorization",
        value: _authz4.ContractExecutionAuthorization.toAmino(_authz4.ContractExecutionAuthorization.decode(content.value))
      };
    case "/cosmwasm.wasm.v1.ContractMigrationAuthorization":
      return {
        type: "wasm/ContractMigrationAuthorization",
        value: _authz4.ContractMigrationAuthorization.toAmino(_authz4.ContractMigrationAuthorization.decode(content.value))
      };
    default:
      return _any.Any.toAmino(content);
  }
