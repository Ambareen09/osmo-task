...
var Cosmos_groupDecisionPolicy_InterfaceDecoder = function Cosmos_groupDecisionPolicy_InterfaceDecoder(input) {
  ...
  switch (data.typeUrl) {
    case "/cosmos.group.v1.ThresholdDecisionPolicy":
      return _types.ThresholdDecisionPolicy.decode(data.value);
    case "/cosmos.group.v1.PercentageDecisionPolicy":
      return _types.PercentageDecisionPolicy.decode(data.value);
    default:
      return data;
  }
};
  ...
  switch (content.type) {
    case "cosmos-sdk/ThresholdDecisionPolicy":
      return _any.Any.fromPartial({
        ...
        value: _types.ThresholdDecisionPolicy.encode(_types.ThresholdDecisionPolicy.fromPartial(content.value)).finish()
      });
    case "cosmos-sdk/PercentageDecisionPolicy":
      return _any.Any.fromPartial({
        typeUrl: "/cosmos.group.v1.PercentageDecisionPolicy",
        value: _types.PercentageDecisionPolicy.encode(_types.PercentageDecisionPolicy.fromPartial(content.value)).finish()
      });
    default:
  ...
  switch (content.typeUrl) {
    case "/cosmos.group.v1.ThresholdDecisionPolicy":
      return {
        ...
        value: _types.ThresholdDecisionPolicy.toAmino(_types.ThresholdDecisionPolicy.decode(content.value))
      };
    case "/cosmos.group.v1.PercentageDecisionPolicy":
      return {
        type: "cosmos-sdk/PercentageDecisionPolicy",
        value: _types.PercentageDecisionPolicy.toAmino(_types.PercentageDecisionPolicy.decode(content.value))
      };
    default:
