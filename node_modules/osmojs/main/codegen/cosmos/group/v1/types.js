...
exports.VoteOptionSDKType = exports.VoteOptionAmino = exports.VoteOption = exports.Vote = exports.ThresholdDecisionPolicy = exports.TallyResult = exports.ProposalStatusSDKType = exports.ProposalStatusAmino = exports.ProposalStatus = exports.ProposalResultSDKType = exports.ProposalResultAmino = exports.ProposalResult = exports.ProposalExecutorResultSDKType = exports.ProposalExecutorResultAmino = exports.ProposalExecutorResult = exports.Proposal = exports.PercentageDecisionPolicy = exports.Members = exports.Member = exports.GroupPolicyInfo = exports.GroupMember = exports.GroupInfo = exports.DecisionPolicyWindows = exports.Cosmos_groupDecisionPolicy_ToAmino = exports.Cosmos_groupDecisionPolicy_InterfaceDecoder = exports.Cosmos_groupDecisionPolicy_FromAmino = void 0;
...
var VoteOptionAmino = VoteOption;
exports.VoteOptionAmino = VoteOptionAmino;
...
var ProposalStatusAmino = ProposalStatus;
exports.ProposalStatusAmino = ProposalStatusAmino;
...
var ProposalResultAmino = ProposalResult;
exports.ProposalResultAmino = ProposalResultAmino;
...
var ProposalExecutorResultAmino = ProposalExecutorResult;
exports.ProposalExecutorResultAmino = ProposalExecutorResultAmino;
...
var Member = {
  ...
  fromAmino: function fromAmino(object) {
    return {
      ...
      addedAt: object !== null && object !== void 0 && object.added_at ? _timestamp.Timestamp.fromAmino(object.added_at) : undefined
    };
  },
  toAmino: function toAmino(message) {
    ...
    obj.added_at = message.addedAt ? _timestamp.Timestamp.toAmino(message.addedAt) : undefined;
    return obj;
  }
};
...
var GroupInfo = {
  ...
  fromAmino: function fromAmino(object) {
    return {
      ...
      admin: object.admin,
      metadata: object.metadata,
      version: _helpers.Long.fromString(object.version),
      totalWeight: object.total_weight,
      createdAt: object !== null && object !== void 0 && object.created_at ? _timestamp.Timestamp.fromAmino(object.created_at) : undefined
    };
  },
  toAmino: function toAmino(message) {
    var obj = {};
    ...
    obj.created_at = message.createdAt ? _timestamp.Timestamp.toAmino(message.createdAt) : undefined;
    return obj;
  }
};
...
var GroupMember = {
  ...
  fromAmino: function fromAmino(object) {
    return {
      groupId: _helpers.Long.fromString(object.group_id),
...
var GroupPolicyInfo = {
  ...
  fromAmino: function fromAmino(object) {
    return {
      ...
      metadata: object.metadata,
      version: _helpers.Long.fromString(object.version),
      decisionPolicy: object !== null && object !== void 0 && object.decision_policy ? Cosmos_groupDecisionPolicy_FromAmino(object.decision_policy) : undefined,
      createdAt: object !== null && object !== void 0 && object.created_at ? _timestamp.Timestamp.fromAmino(object.created_at) : undefined
    };
  },
  toAmino: function toAmino(message) {
...
var Proposal = {
  ...
  fromAmino: function fromAmino(object) {
    return {
      ...
      submitTime: object !== null && object !== void 0 && object.submit_time ? _timestamp.Timestamp.fromAmino(object.submit_time) : undefined,
      groupVersion: _helpers.Long.fromString(object.group_version),
      groupPolicyVersion: _helpers.Long.fromString(object.group_policy_version),
      status: (0, _helpers.isSet)(object.status) ? proposalStatusFromJSON(object.status) : 0,
      result: (0, _helpers.isSet)(object.result) ? proposalResultFromJSON(object.result) : 0,
      ...
      votingPeriodEnd: object !== null && object !== void 0 && object.voting_period_end ? _timestamp.Timestamp.fromAmino(object.voting_period_end) : undefined,
      executorResult: (0, _helpers.isSet)(object.executor_result) ? proposalExecutorResultFromJSON(object.executor_result) : 0,
      messages: Array.isArray(object === null || object === void 0 ? void 0 : object.messages) ? object.messages.map(function (e) {
  ...
  toAmino: function toAmino(message) {
    ...
    obj.submit_time = message.submitTime ? _timestamp.Timestamp.toAmino(message.submitTime) : undefined;
    ...
    obj.voting_period_end = message.votingPeriodEnd ? _timestamp.Timestamp.toAmino(message.votingPeriodEnd) : undefined;
...
exports.Vote = Vote;
var Cosmos_groupDecisionPolicy_InterfaceDecoder = function Cosmos_groupDecisionPolicy_InterfaceDecoder(input) {
  var reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
...
var Cosmos_groupDecisionPolicy_FromAmino = function Cosmos_groupDecisionPolicy_FromAmino(content) {
  switch (content.type) {
    case "cosmos-sdk/ThresholdDecisionPolicy":
      return _any.Any.fromPartial({
        typeUrl: "/cosmos.group.v1.ThresholdDecisionPolicy",
        value: ThresholdDecisionPolicy.encode(ThresholdDecisionPolicy.fromPartial(content.value)).finish()
      });
    case "cosmos-sdk/PercentageDecisionPolicy":
      return _any.Any.fromPartial({
        typeUrl: "/cosmos.group.v1.PercentageDecisionPolicy",
        value: PercentageDecisionPolicy.encode(PercentageDecisionPolicy.fromPartial(content.value)).finish()
      });
    default:
...
var Cosmos_groupDecisionPolicy_ToAmino = function Cosmos_groupDecisionPolicy_ToAmino(content) {
