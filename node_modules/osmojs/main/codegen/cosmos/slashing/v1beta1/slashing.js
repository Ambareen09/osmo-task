...
var ValidatorSigningInfo = {
  ...
  fromAmino: function fromAmino(object) {
    return {
      ...
      startHeight: _helpers.Long.fromString(object.start_height),
      indexOffset: _helpers.Long.fromString(object.index_offset),
      jailedUntil: object !== null && object !== void 0 && object.jailed_until ? _timestamp.Timestamp.fromAmino(object.jailed_until) : undefined,
      tombstoned: object.tombstoned,
      missedBlocksCounter: _helpers.Long.fromString(object.missed_blocks_counter)
    };
  },
  toAmino: function toAmino(message) {
    ...
    obj.jailed_until = message.jailedUntil ? _timestamp.Timestamp.toAmino(message.jailedUntil) : undefined;
...
var Params = {
  ...
  fromAmino: function fromAmino(object) {
    return {
      signedBlocksWindow: _helpers.Long.fromString(object.signed_blocks_window),
