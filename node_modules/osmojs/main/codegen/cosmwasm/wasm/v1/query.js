...
var QueryContractsByCreatorRequest = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      creatorAddress: (0, _helpers.isSet)(object.creatorAddress) ? String(object.creatorAddress) : "",
      pagination: (0, _helpers.isSet)(object.pagination) ? _pagination.PageRequest.fromJSON(object.pagination) : undefined
    };
  },
  toJSON: function toJSON(message) {
...
var QueryContractsByCreatorResponse = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      contractAddresses: Array.isArray(object === null || object === void 0 ? void 0 : object.contractAddresses) ? object.contractAddresses.map(function (e) {
        return String(e);
      }) : [],
      pagination: (0, _helpers.isSet)(object.pagination) ? _pagination.PageResponse.fromJSON(object.pagination) : undefined
    };
  ...
  toJSON: function toJSON(message) {
    ...
    if (message.contractAddresses) {
      obj.contractAddresses = message.contractAddresses.map(function (e) {
        return e;
      });
    } else {
