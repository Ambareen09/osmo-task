...
exports.Params = exports.Model = exports.ContractInfoExtension_ToAmino = exports.ContractInfoExtension_InterfaceDecoder = exports.ContractInfoExtension_FromAmino = exports.ContractInfo = exports.ContractCodeHistoryOperationTypeSDKType = exports.ContractCodeHistoryOperationTypeAmino = exports.ContractCodeHistoryOperationType = exports.ContractCodeHistoryEntry = exports.CodeInfo = exports.AccessTypeSDKType = exports.AccessTypeParam = exports.AccessTypeAmino = exports.AccessType = exports.AccessConfig = exports.AbsoluteTxPosition = void 0;
...
var AccessTypeAmino = AccessType;
exports.AccessTypeAmino = AccessTypeAmino;
...
var ContractCodeHistoryOperationTypeAmino = ContractCodeHistoryOperationType;
exports.ContractCodeHistoryOperationTypeAmino = ContractCodeHistoryOperationTypeAmino;
...
var Params = {
  ...
  fromAmino: function fromAmino(object) {
    return {
      codeUploadAccess: object !== null && object !== void 0 && object.code_upload_access ? AccessConfig.fromAmino(object.code_upload_access) : undefined,
      instantiateDefaultPermission: (0, _helpers.isSet)(object.instantiate_default_permission) ? accessTypeFromJSON(object.instantiate_default_permission) : 0
    };
  },
  toAmino: function toAmino(message) {
    var obj = {};
...
var CodeInfo = {
  ...
  fromAmino: function fromAmino(object) {
    return {
      ...
      instantiateConfig: object !== null && object !== void 0 && object.instantiate_config ? AccessConfig.fromAmino(object.instantiate_config) : undefined
    };
  },
  toAmino: function toAmino(message) {
    var obj = {};
...
var ContractInfo = {
  ...
  fromAmino: function fromAmino(object) {
    return {
      ...
      admin: object.admin,
      label: object.label,
      created: object !== null && object !== void 0 && object.created ? AbsoluteTxPosition.fromAmino(object.created) : undefined,
      ibcPortId: object.ibc_port_id,
      extension: object !== null && object !== void 0 && object.extension ? ContractInfoExtension_FromAmino(object.extension) : undefined
    };
  },
  toAmino: function toAmino(message) {
    var obj = {};
...
var ContractCodeHistoryEntry = {
  ...
  fromAmino: function fromAmino(object) {
    return {
      operation: (0, _helpers.isSet)(object.operation) ? contractCodeHistoryOperationTypeFromJSON(object.operation) : 0,
      codeId: _helpers.Long.fromString(object.code_id),
      updated: object !== null && object !== void 0 && object.updated ? AbsoluteTxPosition.fromAmino(object.updated) : undefined,
...
var AbsoluteTxPosition = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      blockHeight: (0, _helpers.isSet)(object.blockHeight) ? _helpers.Long.fromValue(object.blockHeight) : _helpers.Long.UZERO,
      txIndex: (0, _helpers.isSet)(object.txIndex) ? _helpers.Long.fromValue(object.txIndex) : _helpers.Long.UZERO
    };
  },
  toJSON: function toJSON(message) {
    var obj = {};
  ...
  fromAmino: function fromAmino(object) {
    return {
      blockHeight: _helpers.Long.fromString(object.block_height),
      txIndex: _helpers.Long.fromString(object.tx_index)
    };
  },
  toAmino: function toAmino(message) {
    var obj = {};
...
exports.Model = Model;
var ContractInfoExtension_InterfaceDecoder = function ContractInfoExtension_InterfaceDecoder(input) {
  var reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
...
var ContractInfoExtension_FromAmino = function ContractInfoExtension_FromAmino(content) {
  return _any.Any.fromAmino(content);
};
exports.ContractInfoExtension_FromAmino = ContractInfoExtension_FromAmino;
var ContractInfoExtension_ToAmino = function ContractInfoExtension_ToAmino(content) {
