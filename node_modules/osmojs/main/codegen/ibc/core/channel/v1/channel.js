...
exports.StateSDKType = exports.StateAmino = exports.State = exports.PacketState = exports.Packet = exports.OrderSDKType = exports.OrderAmino = exports.Order = exports.IdentifiedChannel = exports.Counterparty = exports.Channel = exports.Acknowledgement = void 0;
...
var StateAmino = State;
exports.StateAmino = StateAmino;
...
var OrderAmino = Order;
exports.OrderAmino = OrderAmino;
...
var Channel = {
  ...
  fromAmino: function fromAmino(object) {
    return {
      ...
      connectionHops: Array.isArray(object === null || object === void 0 ? void 0 : object.connection_hops) ? object.connection_hops.map(function (e) {
        return e;
      }) : [],
  ...
  toAmino: function toAmino(message) {
    ...
    if (message.connectionHops) {
      obj.connection_hops = message.connectionHops.map(function (e) {
        return e;
      });
    } else {
      obj.connection_hops = [];
...
var Packet = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      ...
      timeoutTimestamp: (0, _helpers.isSet)(object.timeoutTimestamp) ? _helpers.Long.fromValue(object.timeoutTimestamp) : _helpers.Long.UZERO
    };
  },
  toJSON: function toJSON(message) {
    var obj = {};
  ...
  fromAmino: function fromAmino(object) {
    return {
      ...
      data: object.data,
      timeoutHeight: object !== null && object !== void 0 && object.timeout_height ? _client.Height.fromAmino(object.timeout_height) : undefined,
      timeoutTimestamp: _helpers.Long.fromString(object.timeout_timestamp)
    };
  },
  toAmino: function toAmino(message) {
    var obj = {};
    ...
    obj.timeout_height = message.timeoutHeight ? _client.Height.toAmino(message.timeoutHeight) : {};
...
var Acknowledgement = {
  ...
  fromAmino: function fromAmino(object) {
    return {
      result: object === null || object === void 0 ? void 0 : object.result,
      error: object === null || object === void 0 ? void 0 : object.error
    };
  },
  toAmino: function toAmino(message) {
    var obj = {};
