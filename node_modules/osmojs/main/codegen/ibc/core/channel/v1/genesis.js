...
var GenesisState = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      ...
      nextChannelSequence: (0, _helpers.isSet)(object.nextChannelSequence) ? _helpers.Long.fromValue(object.nextChannelSequence) : _helpers.Long.UZERO
    };
  },
  toJSON: function toJSON(message) {
    ...
    message.nextChannelSequence !== undefined && (obj.nextChannelSequence = (message.nextChannelSequence || _helpers.Long.UZERO).toString());
    return obj;
  },
  ...
  fromAmino: function fromAmino(object) {
    return {
      ...
      sendSequences: Array.isArray(object === null || object === void 0 ? void 0 : object.send_sequences) ? object.send_sequences.map(function (e) {
        return PacketSequence.fromAmino(e);
      }) : [],
      recvSequences: Array.isArray(object === null || object === void 0 ? void 0 : object.recv_sequences) ? object.recv_sequences.map(function (e) {
        return PacketSequence.fromAmino(e);
      }) : [],
      ackSequences: Array.isArray(object === null || object === void 0 ? void 0 : object.ack_sequences) ? object.ack_sequences.map(function (e) {
        return PacketSequence.fromAmino(e);
      }) : [],
      nextChannelSequence: _helpers.Long.fromString(object.next_channel_sequence)
    };
  },
  toAmino: function toAmino(message) {
    ...
    if (message.sendSequences) {
      obj.send_sequences = message.sendSequences.map(function (e) {
        return e ? PacketSequence.toAmino(e) : undefined;
      });
    } else {
      obj.send_sequences = [];
    }
    if (message.recvSequences) {
      obj.recv_sequences = message.recvSequences.map(function (e) {
        return e ? PacketSequence.toAmino(e) : undefined;
      });
    } else {
      obj.recv_sequences = [];
    ...
    if (message.ackSequences) {
      obj.ack_sequences = message.ackSequences.map(function (e) {
        return e ? PacketSequence.toAmino(e) : undefined;
      });
    } else {
      obj.ack_sequences = [];
