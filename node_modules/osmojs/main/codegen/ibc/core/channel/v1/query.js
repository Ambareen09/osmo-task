...
var QueryChannelsResponse = {
  ...
  fromAmino: function fromAmino(object) {
    return {
      channels: Array.isArray(object === null || object === void 0 ? void 0 : object.channels) ? object.channels.map(function (e) {
        return _channel.IdentifiedChannel.fromAmino(e);
      }) : [],
      pagination: object !== null && object !== void 0 && object.pagination ? _pagination.PageResponse.fromAmino(object.pagination) : undefined,
      height: object !== null && object !== void 0 && object.height ? _client.Height.fromAmino(object.height) : undefined
    };
  },
  toAmino: function toAmino(message) {
    var obj = {};
    if (message.channels) {
      obj.channels = message.channels.map(function (e) {
        return e ? _channel.IdentifiedChannel.toAmino(e) : undefined;
      });
    } else {
      obj.channels = [];
    }
...
var QueryChannelClientStateResponse = {
  ...
  fromAmino: function fromAmino(object) {
    return {
      identifiedClientState: object !== null && object !== void 0 && object.identified_client_state ? _client.IdentifiedClientState.fromAmino(object.identified_client_state) : undefined,
      proof: object.proof,
      proofHeight: object !== null && object !== void 0 && object.proof_height ? _client.Height.fromAmino(object.proof_height) : undefined
    };
  },
...
var QueryChannelConsensusStateRequest = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      portId: (0, _helpers.isSet)(object.portId) ? String(object.portId) : "",
      channelId: (0, _helpers.isSet)(object.channelId) ? String(object.channelId) : "",
      revisionNumber: (0, _helpers.isSet)(object.revisionNumber) ? _helpers.Long.fromValue(object.revisionNumber) : _helpers.Long.UZERO,
      revisionHeight: (0, _helpers.isSet)(object.revisionHeight) ? _helpers.Long.fromValue(object.revisionHeight) : _helpers.Long.UZERO
    };
  },
  toJSON: function toJSON(message) {
    var obj = {};
  ...
  fromAmino: function fromAmino(object) {
    return {
      portId: object.port_id,
      channelId: object.channel_id,
      revisionNumber: _helpers.Long.fromString(object.revision_number),
      revisionHeight: _helpers.Long.fromString(object.revision_height)
    };
  },
  toAmino: function toAmino(message) {
    var obj = {};
...
var QueryPacketCommitmentsResponse = {
  ...
  fromAmino: function fromAmino(object) {
    return {
      commitments: Array.isArray(object === null || object === void 0 ? void 0 : object.commitments) ? object.commitments.map(function (e) {
        return _channel.PacketState.fromAmino(e);
      }) : [],
      pagination: object !== null && object !== void 0 && object.pagination ? _pagination.PageResponse.fromAmino(object.pagination) : undefined,
      height: object !== null && object !== void 0 && object.height ? _client.Height.fromAmino(object.height) : undefined
    };
  ...
  toAmino: function toAmino(message) {
    ...
    if (message.commitments) {
      obj.commitments = message.commitments.map(function (e) {
        return e ? _channel.PacketState.toAmino(e) : undefined;
      });
    } else {
      obj.commitments = [];
    }
...
var QueryPacketAcknowledgementsRequest = {
  ...
  fromAmino: function fromAmino(object) {
    return {
      ...
      channelId: object.channel_id,
      pagination: object !== null && object !== void 0 && object.pagination ? _pagination.PageRequest.fromAmino(object.pagination) : undefined,
      packetCommitmentSequences: Array.isArray(object === null || object === void 0 ? void 0 : object.packet_commitment_sequences) ? object.packet_commitment_sequences.map(function (e) {
        return e;
      }) : []
    };
  },
  toAmino: function toAmino(message) {
    ...
    obj.pagination = message.pagination ? _pagination.PageRequest.toAmino(message.pagination) : undefined;
    if (message.packetCommitmentSequences) {
      obj.packet_commitment_sequences = message.packetCommitmentSequences.map(function (e) {
        return e;
      });
    } else {
...
var QueryUnreceivedAcksRequest = {
  ...
  fromAmino: function fromAmino(object) {
    return {
      portId: object.port_id,
      channelId: object.channel_id,
      packetAckSequences: Array.isArray(object === null || object === void 0 ? void 0 : object.packet_ack_sequences) ? object.packet_ack_sequences.map(function (e) {
        return e;
      }) : []
    };
  },
  toAmino: function toAmino(message) {
    ...
    obj.channel_id = message.channelId;
    if (message.packetAckSequences) {
      obj.packet_ack_sequences = message.packetAckSequences.map(function (e) {
        return e;
      });
    } else {
...
var QueryNextSequenceReceiveResponse = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      nextSequenceReceive: (0, _helpers.isSet)(object.nextSequenceReceive) ? _helpers.Long.fromValue(object.nextSequenceReceive) : _helpers.Long.UZERO,
      proof: (0, _helpers.isSet)(object.proof) ? (0, _helpers.bytesFromBase64)(object.proof) : new Uint8Array(),
      proofHeight: (0, _helpers.isSet)(object.proofHeight) ? _client.Height.fromJSON(object.proofHeight) : undefined
    };
  },
  ...
  fromAmino: function fromAmino(object) {
    return {
      nextSequenceReceive: _helpers.Long.fromString(object.next_sequence_receive),
      proof: object.proof,
      proofHeight: object !== null && object !== void 0 && object.proof_height ? _client.Height.fromAmino(object.proof_height) : undefined
    };
  },
