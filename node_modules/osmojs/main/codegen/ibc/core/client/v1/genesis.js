...
var GenesisState = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      ...
      clientsConsensus: Array.isArray(object === null || object === void 0 ? void 0 : object.clientsConsensus) ? object.clientsConsensus.map(function (e) {
        return _client.ClientConsensusStates.fromJSON(e);
      }) : [],
      ...
      createLocalhost: (0, _helpers.isSet)(object.createLocalhost) ? Boolean(object.createLocalhost) : false,
      nextClientSequence: (0, _helpers.isSet)(object.nextClientSequence) ? _helpers.Long.fromValue(object.nextClientSequence) : _helpers.Long.UZERO
    };
  },
  toJSON: function toJSON(message) {
    ...
    if (message.clientsConsensus) {
      obj.clientsConsensus = message.clientsConsensus.map(function (e) {
        return e ? _client.ClientConsensusStates.toJSON(e) : undefined;
      });
    } else {
    ...
    message.nextClientSequence !== undefined && (obj.nextClientSequence = (message.nextClientSequence || _helpers.Long.UZERO).toString());
    return obj;
  },
  ...
  fromAmino: function fromAmino(object) {
    return {
      clients: Array.isArray(object === null || object === void 0 ? void 0 : object.clients) ? object.clients.map(function (e) {
        return _client.IdentifiedClientState.fromAmino(e);
      }) : [],
      clientsConsensus: Array.isArray(object === null || object === void 0 ? void 0 : object.clients_consensus) ? object.clients_consensus.map(function (e) {
        return _client.ClientConsensusStates.fromAmino(e);
      }) : [],
      clientsMetadata: Array.isArray(object === null || object === void 0 ? void 0 : object.clients_metadata) ? object.clients_metadata.map(function (e) {
        return IdentifiedGenesisMetadata.fromAmino(e);
      }) : [],
      params: object !== null && object !== void 0 && object.params ? _client.Params.fromAmino(object.params) : undefined,
      createLocalhost: object.create_localhost,
      nextClientSequence: _helpers.Long.fromString(object.next_client_sequence)
    };
  },
  toAmino: function toAmino(message) {
    ...
    if (message.clients) {
      obj.clients = message.clients.map(function (e) {
        return e ? _client.IdentifiedClientState.toAmino(e) : undefined;
      });
    } else {
      obj.clients = [];
    }
    if (message.clientsConsensus) {
      obj.clients_consensus = message.clientsConsensus.map(function (e) {
        return e ? _client.ClientConsensusStates.toAmino(e) : undefined;
      });
    } else {
      obj.clients_consensus = [];
    }
    if (message.clientsMetadata) {
      obj.clients_metadata = message.clientsMetadata.map(function (e) {
        return e ? IdentifiedGenesisMetadata.toAmino(e) : undefined;
      });
    } else {
      obj.clients_metadata = [];
    }
    obj.params = message.params ? _client.Params.toAmino(message.params) : undefined;
...
var IdentifiedGenesisMetadata = {
  ...
  fromAmino: function fromAmino(object) {
    return {
      ...
      clientMetadata: Array.isArray(object === null || object === void 0 ? void 0 : object.client_metadata) ? object.client_metadata.map(function (e) {
        return GenesisMetadata.fromAmino(e);
      }) : []
    };
  },
  toAmino: function toAmino(message) {
    ...
    if (message.clientMetadata) {
      obj.client_metadata = message.clientMetadata.map(function (e) {
        return e ? GenesisMetadata.toAmino(e) : undefined;
      });
    } else {
      obj.client_metadata = [];
    }
