...
var MessageComposer = {
  ...
  toJSON: {
    createClient: function createClient(value) {
      return {
        typeUrl: "/ibc.core.client.v1.MsgCreateClient",
        value: _tx.MsgCreateClient.toJSON(value)
      };
    },
    updateClient: function updateClient(value) {
      return {
        typeUrl: "/ibc.core.client.v1.MsgUpdateClient",
        value: _tx.MsgUpdateClient.toJSON(value)
      };
    },
    upgradeClient: function upgradeClient(value) {
      return {
        typeUrl: "/ibc.core.client.v1.MsgUpgradeClient",
        value: _tx.MsgUpgradeClient.toJSON(value)
      };
    },
    submitMisbehaviour: function submitMisbehaviour(value) {
      return {
        typeUrl: "/ibc.core.client.v1.MsgSubmitMisbehaviour",
        value: _tx.MsgSubmitMisbehaviour.toJSON(value)
      };
    }
  },
  fromJSON: {
    createClient: function createClient(value) {
      return {
        typeUrl: "/ibc.core.client.v1.MsgCreateClient",
        value: _tx.MsgCreateClient.fromJSON(value)
      };
    },
    updateClient: function updateClient(value) {
      return {
        typeUrl: "/ibc.core.client.v1.MsgUpdateClient",
        value: _tx.MsgUpdateClient.fromJSON(value)
      };
    },
    upgradeClient: function upgradeClient(value) {
      return {
        typeUrl: "/ibc.core.client.v1.MsgUpgradeClient",
        value: _tx.MsgUpgradeClient.fromJSON(value)
      };
    },
    submitMisbehaviour: function submitMisbehaviour(value) {
      return {
        typeUrl: "/ibc.core.client.v1.MsgSubmitMisbehaviour",
        value: _tx.MsgSubmitMisbehaviour.fromJSON(value)
      };
    }
  },
  fromPartial: {
