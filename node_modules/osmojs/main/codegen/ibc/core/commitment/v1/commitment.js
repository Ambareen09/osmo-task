...
var MerklePrefix = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      keyPrefix: (0, _helpers.isSet)(object.keyPrefix) ? (0, _helpers.bytesFromBase64)(object.keyPrefix) : new Uint8Array()
    };
  },
  toJSON: function toJSON(message) {
    var obj = {};
    message.keyPrefix !== undefined && (obj.keyPrefix = (0, _helpers.base64FromBytes)(message.keyPrefix !== undefined ? message.keyPrefix : new Uint8Array()));
    return obj;
  },
  fromPartial: function fromPartial(object) {
...
var MerklePath = {
  ...
  fromAmino: function fromAmino(object) {
    return {
      keyPath: Array.isArray(object === null || object === void 0 ? void 0 : object.key_path) ? object.key_path.map(function (e) {
        return e;
      }) : []
    };
  },
  toAmino: function toAmino(message) {
    var obj = {};
    if (message.keyPath) {
      obj.key_path = message.keyPath.map(function (e) {
        return e;
      });
    } else {
      obj.key_path = [];
...
var MerkleProof = {
  ...
  toJSON: function toJSON(message) {
    ...
    if (message.proofs) {
      obj.proofs = message.proofs.map(function (e) {
        return e ? _proofs.CommitmentProof.toJSON(e) : undefined;
      });
    } else {
      obj.proofs = [];
    }
  ...
  fromAmino: function fromAmino(object) {
    return {
      proofs: Array.isArray(object === null || object === void 0 ? void 0 : object.proofs) ? object.proofs.map(function (e) {
        return _proofs.CommitmentProof.fromAmino(e);
      }) : []
    };
  },
  toAmino: function toAmino(message) {
    ...
    if (message.proofs) {
      obj.proofs = message.proofs.map(function (e) {
        return e ? _proofs.CommitmentProof.toAmino(e) : undefined;
      });
    } else {
      obj.proofs = [];
    }
