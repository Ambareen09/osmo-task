...
var GenesisState = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      ...
      nextConnectionSequence: (0, _helpers.isSet)(object.nextConnectionSequence) ? _helpers.Long.fromValue(object.nextConnectionSequence) : _helpers.Long.UZERO,
  ...
  fromAmino: function fromAmino(object) {
    return {
      ...
      clientConnectionPaths: Array.isArray(object === null || object === void 0 ? void 0 : object.client_connection_paths) ? object.client_connection_paths.map(function (e) {
        return _connection.ConnectionPaths.fromAmino(e);
      }) : [],
      nextConnectionSequence: _helpers.Long.fromString(object.next_connection_sequence),
      params: object !== null && object !== void 0 && object.params ? _connection.Params.fromAmino(object.params) : undefined
    };
  },
  toAmino: function toAmino(message) {
    ...
    if (message.clientConnectionPaths) {
      obj.client_connection_paths = message.clientConnectionPaths.map(function (e) {
        return e ? _connection.ConnectionPaths.toAmino(e) : undefined;
      });
    } else {
    ...
    obj.params = message.params ? _connection.Params.toAmino(message.params) : undefined;
    return obj;
  }
};
