...
var MsgConnectionOpenInit = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      ...
      delayPeriod: (0, _helpers.isSet)(object.delayPeriod) ? _helpers.Long.fromValue(object.delayPeriod) : _helpers.Long.UZERO,
  ...
  fromAmino: function fromAmino(object) {
    return {
      ...
      counterparty: object !== null && object !== void 0 && object.counterparty ? _connection.Counterparty.fromAmino(object.counterparty) : undefined,
      version: object !== null && object !== void 0 && object.version ? _connection.Version.fromAmino(object.version) : undefined,
      delayPeriod: _helpers.Long.fromString(object.delay_period),
  ...
  toAmino: function toAmino(message) {
    ...
    obj.counterparty = message.counterparty ? _connection.Counterparty.toAmino(message.counterparty) : undefined;
    obj.version = message.version ? _connection.Version.toAmino(message.version) : undefined;
...
var MsgConnectionOpenTry = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      clientId: (0, _helpers.isSet)(object.clientId) ? String(object.clientId) : "",
      previousConnectionId: (0, _helpers.isSet)(object.previousConnectionId) ? String(object.previousConnectionId) : "",
      ...
      proofClient: (0, _helpers.isSet)(object.proofClient) ? (0, _helpers.bytesFromBase64)(object.proofClient) : new Uint8Array(),
      proofConsensus: (0, _helpers.isSet)(object.proofConsensus) ? (0, _helpers.bytesFromBase64)(object.proofConsensus) : new Uint8Array(),
      consensusHeight: (0, _helpers.isSet)(object.consensusHeight) ? _client.Height.fromJSON(object.consensusHeight) : undefined,
      signer: (0, _helpers.isSet)(object.signer) ? String(object.signer) : ""
    };
  },
  toJSON: function toJSON(message) {
    ...
    message.proofClient !== undefined && (obj.proofClient = (0, _helpers.base64FromBytes)(message.proofClient !== undefined ? message.proofClient : new Uint8Array()));
    message.proofConsensus !== undefined && (obj.proofConsensus = (0, _helpers.base64FromBytes)(message.proofConsensus !== undefined ? message.proofConsensus : new Uint8Array()));
    message.consensusHeight !== undefined && (obj.consensusHeight = message.consensusHeight ? _client.Height.toJSON(message.consensusHeight) : undefined);
    message.signer !== undefined && (obj.signer = message.signer);
    return obj;
  },
  fromPartial: function fromPartial(object) {
  ...
  fromAmino: function fromAmino(object) {
    return {
      ...
      counterparty: object !== null && object !== void 0 && object.counterparty ? _connection.Counterparty.fromAmino(object.counterparty) : undefined,
      delayPeriod: _helpers.Long.fromString(object.delay_period),
      counterpartyVersions: Array.isArray(object === null || object === void 0 ? void 0 : object.counterparty_versions) ? object.counterparty_versions.map(function (e) {
        return _connection.Version.fromAmino(e);
      }) : [],
      proofHeight: object !== null && object !== void 0 && object.proof_height ? _client.Height.fromAmino(object.proof_height) : undefined,
      proofInit: object.proof_init,
      proofClient: object.proof_client,
      proofConsensus: object.proof_consensus,
      consensusHeight: object !== null && object !== void 0 && object.consensus_height ? _client.Height.fromAmino(object.consensus_height) : undefined,
      signer: object.signer
    };
  },
  toAmino: function toAmino(message) {
    ...
    obj.delay_period = message.delayPeriod ? message.delayPeriod.toString() : undefined;
    if (message.counterpartyVersions) {
      obj.counterparty_versions = message.counterpartyVersions.map(function (e) {
        return e ? _connection.Version.toAmino(e) : undefined;
      });
    } else {
    ...
    obj.consensus_height = message.consensusHeight ? _client.Height.toAmino(message.consensusHeight) : {};
    obj.signer = message.signer;
    return obj;
  }
};
...
var MsgConnectionOpenAck = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      ...
      counterpartyConnectionId: (0, _helpers.isSet)(object.counterpartyConnectionId) ? String(object.counterpartyConnectionId) : "",
      version: (0, _helpers.isSet)(object.version) ? _connection.Version.fromJSON(object.version) : undefined,
      clientState: (0, _helpers.isSet)(object.clientState) ? _any.Any.fromJSON(object.clientState) : undefined,
      proofHeight: (0, _helpers.isSet)(object.proofHeight) ? _client.Height.fromJSON(object.proofHeight) : undefined,
