...
exports.TimestampedSignatureData = exports.SignatureAndData = exports.SignBytes = exports.PacketReceiptAbsenceData = exports.PacketCommitmentData = exports.PacketAcknowledgementData = exports.NextSequenceRecvData = exports.Misbehaviour = exports.HeaderData = exports.Header = exports.DataTypeSDKType = exports.DataTypeAmino = exports.DataType = exports.ConsensusStateData = exports.ConsensusState = exports.ConnectionStateData = exports.ClientStateData = exports.ClientState = exports.ChannelStateData = void 0;
...
var DataTypeAmino = DataType;
exports.DataTypeAmino = DataTypeAmino;
...
var ClientState = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      ...
      frozenSequence: (0, _helpers.isSet)(object.frozenSequence) ? _helpers.Long.fromValue(object.frozenSequence) : _helpers.Long.UZERO,
      consensusState: (0, _helpers.isSet)(object.consensusState) ? ConsensusState.fromJSON(object.consensusState) : undefined,
      allowUpdateAfterProposal: (0, _helpers.isSet)(object.allowUpdateAfterProposal) ? Boolean(object.allowUpdateAfterProposal) : false
    };
  },
  toJSON: function toJSON(message) {
    var obj = {};
    message.sequence !== undefined && (obj.sequence = (message.sequence || _helpers.Long.UZERO).toString());
    message.frozenSequence !== undefined && (obj.frozenSequence = (message.frozenSequence || _helpers.Long.UZERO).toString());
  ...
  fromAmino: function fromAmino(object) {
    return {
      ...
      frozenSequence: _helpers.Long.fromString(object.frozen_sequence),
...
var ConsensusState = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      ...
      diversifier: (0, _helpers.isSet)(object.diversifier) ? String(object.diversifier) : "",
  ...
  toJSON: function toJSON(message) {
    ...
    message.timestamp !== undefined && (obj.timestamp = (message.timestamp || _helpers.Long.UZERO).toString());
    return obj;
  },
  fromPartial: function fromPartial(object) {
  ...
  fromAmino: function fromAmino(object) {
    return {
      ...
      timestamp: _helpers.Long.fromString(object.timestamp)
    };
  },
  toAmino: function toAmino(message) {
    var obj = {};
...
var Header = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      ...
      newPublicKey: (0, _helpers.isSet)(object.newPublicKey) ? _any.Any.fromJSON(object.newPublicKey) : undefined,
      newDiversifier: (0, _helpers.isSet)(object.newDiversifier) ? String(object.newDiversifier) : ""
    };
  },
  toJSON: function toJSON(message) {
    var obj = {};
    ...
    message.newPublicKey !== undefined && (obj.newPublicKey = message.newPublicKey ? _any.Any.toJSON(message.newPublicKey) : undefined);
  ...
  fromAmino: function fromAmino(object) {
    return {
      ...
      newPublicKey: object !== null && object !== void 0 && object.new_public_key ? _any.Any.fromAmino(object.new_public_key) : undefined,
  ...
  toAmino: function toAmino(message) {
    ...
    obj.new_public_key = message.newPublicKey ? _any.Any.toAmino(message.newPublicKey) : undefined;
...
var Misbehaviour = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      ...
      sequence: (0, _helpers.isSet)(object.sequence) ? _helpers.Long.fromValue(object.sequence) : _helpers.Long.UZERO,
      signatureOne: (0, _helpers.isSet)(object.signatureOne) ? SignatureAndData.fromJSON(object.signatureOne) : undefined,
      signatureTwo: (0, _helpers.isSet)(object.signatureTwo) ? SignatureAndData.fromJSON(object.signatureTwo) : undefined
    };
  },
  toJSON: function toJSON(message) {
    var obj = {};
...
var SignatureAndData = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      signature: (0, _helpers.isSet)(object.signature) ? (0, _helpers.bytesFromBase64)(object.signature) : new Uint8Array(),
      dataType: (0, _helpers.isSet)(object.dataType) ? dataTypeFromJSON(object.dataType) : 0,
  ...
  fromAmino: function fromAmino(object) {
    return {
      signature: object.signature,
      dataType: (0, _helpers.isSet)(object.data_type) ? dataTypeFromJSON(object.data_type) : 0,
      data: object.data,
      timestamp: _helpers.Long.fromString(object.timestamp)
    };
  },
...
var TimestampedSignatureData = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      signatureData: (0, _helpers.isSet)(object.signatureData) ? (0, _helpers.bytesFromBase64)(object.signatureData) : new Uint8Array(),
      timestamp: (0, _helpers.isSet)(object.timestamp) ? _helpers.Long.fromValue(object.timestamp) : _helpers.Long.UZERO
    };
  },
  toJSON: function toJSON(message) {
    var obj = {};
    message.signatureData !== undefined && (obj.signatureData = (0, _helpers.base64FromBytes)(message.signatureData !== undefined ? message.signatureData : new Uint8Array()));
    message.timestamp !== undefined && (obj.timestamp = (message.timestamp || _helpers.Long.UZERO).toString());
    return obj;
  },
  fromPartial: function fromPartial(object) {
...
var HeaderData = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      newPubKey: (0, _helpers.isSet)(object.newPubKey) ? _any.Any.fromJSON(object.newPubKey) : undefined,
      newDiversifier: (0, _helpers.isSet)(object.newDiversifier) ? String(object.newDiversifier) : ""
    };
  },
  toJSON: function toJSON(message) {
    var obj = {};
    message.newPubKey !== undefined && (obj.newPubKey = message.newPubKey ? _any.Any.toJSON(message.newPubKey) : undefined);
    message.newDiversifier !== undefined && (obj.newDiversifier = message.newDiversifier);
    return obj;
  },
  fromPartial: function fromPartial(object) {
  ...
  fromAmino: function fromAmino(object) {
    return {
      newPubKey: object !== null && object !== void 0 && object.new_pub_key ? _any.Any.fromAmino(object.new_pub_key) : undefined,
      newDiversifier: object.new_diversifier
    };
  },
  toAmino: function toAmino(message) {
    var obj = {};
    obj.new_pub_key = message.newPubKey ? _any.Any.toAmino(message.newPubKey) : undefined;
    obj.new_diversifier = message.newDiversifier;
    return obj;
  }
};
...
var ClientStateData = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      path: (0, _helpers.isSet)(object.path) ? (0, _helpers.bytesFromBase64)(object.path) : new Uint8Array(),
      clientState: (0, _helpers.isSet)(object.clientState) ? _any.Any.fromJSON(object.clientState) : undefined
    };
  },
  toJSON: function toJSON(message) {
    var obj = {};
    message.path !== undefined && (obj.path = (0, _helpers.base64FromBytes)(message.path !== undefined ? message.path : new Uint8Array()));
...
var ConnectionStateData = {
  ...
  fromAmino: function fromAmino(object) {
    return {
      path: object.path,
      connection: object !== null && object !== void 0 && object.connection ? _connection.ConnectionEnd.fromAmino(object.connection) : undefined
    };
  },
  toAmino: function toAmino(message) {
    var obj = {};
...
var ChannelStateData = {
  ...
  fromAmino: function fromAmino(object) {
    return {
      path: object.path,
      channel: object !== null && object !== void 0 && object.channel ? _channel.Channel.fromAmino(object.channel) : undefined
    };
  },
  toAmino: function toAmino(message) {
    var obj = {};
    obj.path = message.path;
    obj.channel = message.channel ? _channel.Channel.toAmino(message.channel) : undefined;
    return obj;
  }
};
...
var NextSequenceRecvData = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      path: (0, _helpers.isSet)(object.path) ? (0, _helpers.bytesFromBase64)(object.path) : new Uint8Array(),
      nextSeqRecv: (0, _helpers.isSet)(object.nextSeqRecv) ? _helpers.Long.fromValue(object.nextSeqRecv) : _helpers.Long.UZERO
    };
  },
  toJSON: function toJSON(message) {
    var obj = {};
    message.path !== undefined && (obj.path = (0, _helpers.base64FromBytes)(message.path !== undefined ? message.path : new Uint8Array()));
    message.nextSeqRecv !== undefined && (obj.nextSeqRecv = (message.nextSeqRecv || _helpers.Long.UZERO).toString());
    return obj;
  },
  fromPartial: function fromPartial(object) {
    var _object$path8;
  ...
  fromAmino: function fromAmino(object) {
    return {
      path: object.path,
      nextSeqRecv: _helpers.Long.fromString(object.next_seq_recv)
    };
  },
  toAmino: function toAmino(message) {
    var obj = {};
