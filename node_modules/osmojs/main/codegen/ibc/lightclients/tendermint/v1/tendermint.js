...
var ClientState = {
  ...
  toJSON: function toJSON(message) {
    ...
    message.trustingPeriod !== undefined && (obj.trustingPeriod = message.trustingPeriod ? _duration.Duration.toJSON(message.trustingPeriod) : undefined);
    message.unbondingPeriod !== undefined && (obj.unbondingPeriod = message.unbondingPeriod ? _duration.Duration.toJSON(message.unbondingPeriod) : undefined);
    message.maxClockDrift !== undefined && (obj.maxClockDrift = message.maxClockDrift ? _duration.Duration.toJSON(message.maxClockDrift) : undefined);
  ...
  fromAmino: function fromAmino(object) {
    return {
      ...
      trustingPeriod: object !== null && object !== void 0 && object.trusting_period ? _duration.Duration.fromAmino(object.trusting_period) : undefined,
      unbondingPeriod: object !== null && object !== void 0 && object.unbonding_period ? _duration.Duration.fromAmino(object.unbonding_period) : undefined,
      maxClockDrift: object !== null && object !== void 0 && object.max_clock_drift ? _duration.Duration.fromAmino(object.max_clock_drift) : undefined,
      frozenHeight: object !== null && object !== void 0 && object.frozen_height ? _client.Height.fromAmino(object.frozen_height) : undefined,
      latestHeight: object !== null && object !== void 0 && object.latest_height ? _client.Height.fromAmino(object.latest_height) : undefined,
      proofSpecs: Array.isArray(object === null || object === void 0 ? void 0 : object.proof_specs) ? object.proof_specs.map(function (e) {
        return _proofs.ProofSpec.fromAmino(e);
      }) : [],
      upgradePath: Array.isArray(object === null || object === void 0 ? void 0 : object.upgrade_path) ? object.upgrade_path.map(function (e) {
        return e;
      }) : [],
  ...
  toAmino: function toAmino(message) {
    ...
    obj.trusting_period = message.trustingPeriod ? _duration.Duration.toAmino(message.trustingPeriod) : undefined;
    obj.unbonding_period = message.unbondingPeriod ? _duration.Duration.toAmino(message.unbondingPeriod) : undefined;
    obj.max_clock_drift = message.maxClockDrift ? _duration.Duration.toAmino(message.maxClockDrift) : undefined;
    obj.frozen_height = message.frozenHeight ? _client.Height.toAmino(message.frozenHeight) : {};
    obj.latest_height = message.latestHeight ? _client.Height.toAmino(message.latestHeight) : {};
    if (message.proofSpecs) {
      obj.proof_specs = message.proofSpecs.map(function (e) {
        return e ? _proofs.ProofSpec.toAmino(e) : undefined;
      });
    } else {
      obj.proof_specs = [];
    }
    if (message.upgradePath) {
      obj.upgrade_path = message.upgradePath.map(function (e) {
        return e;
      });
    } else {
      obj.upgrade_path = [];
...
var ConsensusState = {
  ...
  fromAmino: function fromAmino(object) {
    return {
      ...
      root: object !== null && object !== void 0 && object.root ? _commitment.MerkleRoot.fromAmino(object.root) : undefined,
  ...
  toAmino: function toAmino(message) {
    ...
    obj.root = message.root ? _commitment.MerkleRoot.toAmino(message.root) : undefined;
...
var Misbehaviour = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      ...
      header1: (0, _helpers.isSet)(object.header1) ? Header.fromJSON(object.header1) : undefined,
      header2: (0, _helpers.isSet)(object.header2) ? Header.fromJSON(object.header2) : undefined
    };
  },
  toJSON: function toJSON(message) {
    var obj = {};
...
var Header = {
  ...
  fromAmino: function fromAmino(object) {
    return {
      signedHeader: object !== null && object !== void 0 && object.signed_header ? _types.SignedHeader.fromAmino(object.signed_header) : undefined,
      ...
      trustedHeight: object !== null && object !== void 0 && object.trusted_height ? _client.Height.fromAmino(object.trusted_height) : undefined,
      trustedValidators: object !== null && object !== void 0 && object.trusted_validators ? _validator.ValidatorSet.fromAmino(object.trusted_validators) : undefined
    };
  },
  toAmino: function toAmino(message) {
    var obj = {};
    obj.signed_header = message.signedHeader ? _types.SignedHeader.toAmino(message.signedHeader) : undefined;
    obj.validator_set = message.validatorSet ? _validator.ValidatorSet.toAmino(message.validatorSet) : undefined;
    obj.trusted_height = message.trustedHeight ? _client.Height.toAmino(message.trustedHeight) : {};
    obj.trusted_validators = message.trustedValidators ? _validator.ValidatorSet.toAmino(message.trustedValidators) : undefined;
    return obj;
  }
};
...
var Fraction = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      numerator: (0, _helpers.isSet)(object.numerator) ? _helpers.Long.fromValue(object.numerator) : _helpers.Long.UZERO,
      denominator: (0, _helpers.isSet)(object.denominator) ? _helpers.Long.fromValue(object.denominator) : _helpers.Long.UZERO
    };
  },
  toJSON: function toJSON(message) {
    var obj = {};
  ...
  fromAmino: function fromAmino(object) {
    return {
      numerator: _helpers.Long.fromString(object.numerator),
      denominator: _helpers.Long.fromString(object.denominator)
    };
  },
  toAmino: function toAmino(message) {
    var obj = {};
