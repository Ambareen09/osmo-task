...
var RecoveredSinceDowntimeOfLengthRequest = {
  ...
  toJSON: function toJSON(message) {
    var obj = {};
    message.downtime !== undefined && (obj.downtime = (0, _downtime_duration.downtimeToJSON)(message.downtime));
    message.recovery !== undefined && (obj.recovery = message.recovery ? _duration.Duration.toJSON(message.recovery) : undefined);
    return obj;
  },
