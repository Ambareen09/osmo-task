...
var SmoothWeightChangeParams = {
  encode: function encode(message) {
    ...
    if (message.startTime !== undefined) {
      _timestamp.Timestamp.encode(message.startTime, writer.uint32(10).fork()).ldelim();
    }
  ...
  toJSON: function toJSON(message) {
    ...
    if (message.initialPoolWeights) {
      obj.initialPoolWeights = message.initialPoolWeights.map(function (e) {
        return e ? PoolAsset.toJSON(e) : undefined;
      });
    } else {
      obj.initialPoolWeights = [];
    }
    if (message.targetPoolWeights) {
      obj.targetPoolWeights = message.targetPoolWeights.map(function (e) {
        return e ? PoolAsset.toJSON(e) : undefined;
      });
    } else {
  ...
  fromPartial: function fromPartial(object) {
    var _object$initialPoolWe, _object$targetPoolWei;
    var message = createBaseSmoothWeightChangeParams();
...
var Pool = {
  ...
  toJSON: function toJSON(message) {
    ...
    if (message.poolAssets) {
      obj.poolAssets = message.poolAssets.map(function (e) {
        return e ? PoolAsset.toJSON(e) : undefined;
      });
    } else {
      obj.poolAssets = [];
