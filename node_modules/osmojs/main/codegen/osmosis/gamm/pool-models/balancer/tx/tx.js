...
var MsgCreateBalancerPool = {
  ...
  toJSON: function toJSON(message) {
    ...
    message.poolParams !== undefined && (obj.poolParams = message.poolParams ? _balancerPool.PoolParams.toJSON(message.poolParams) : undefined);
    if (message.poolAssets) {
      obj.poolAssets = message.poolAssets.map(function (e) {
        return e ? _balancerPool.PoolAsset.toJSON(e) : undefined;
      });
    } else {
      obj.poolAssets = [];
    }
