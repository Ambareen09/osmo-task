...
var Pool = {
  ...
  toJSON: function toJSON(message) {
    ...
    if (message.poolLiquidity) {
      obj.poolLiquidity = message.poolLiquidity.map(function (e) {
  ...
  fromAmino: function fromAmino(object) {
    return {
      ...
      poolLiquidity: Array.isArray(object === null || object === void 0 ? void 0 : object.pool_liquidity) ? object.pool_liquidity.map(function (e) {
  ...
  toAmino: function toAmino(message) {
    ...
    if (message.poolLiquidity) {
      obj.pool_liquidity = message.poolLiquidity.map(function (e) {
