...
var MsgCreateStableswapPool = {
  ...
  toJSON: function toJSON(message) {
    ...
    message.poolParams !== undefined && (obj.poolParams = message.poolParams ? _stableswap_pool.PoolParams.toJSON(message.poolParams) : undefined);
    if (message.initialPoolLiquidity) {
      obj.initialPoolLiquidity = message.initialPoolLiquidity.map(function (e) {
    ...
    if (message.scalingFactors) {
      obj.scalingFactors = message.scalingFactors.map(function (e) {
  ...
  fromAmino: function fromAmino(object) {
    return {
      ...
      poolParams: object !== null && object !== void 0 && object.pool_params ? _stableswap_pool.PoolParams.fromAmino(object.pool_params) : undefined,
      initialPoolLiquidity: Array.isArray(object === null || object === void 0 ? void 0 : object.initial_pool_liquidity) ? object.initial_pool_liquidity.map(function (e) {
        return _coin.Coin.fromAmino(e);
      }) : [],
      scalingFactors: Array.isArray(object === null || object === void 0 ? void 0 : object.scaling_factors) ? object.scaling_factors.map(function (e) {
        return e;
      }) : [],
  ...
  toAmino: function toAmino(message) {
    ...
    obj.pool_params = message.poolParams ? _stableswap_pool.PoolParams.toAmino(message.poolParams) : undefined;
    if (message.initialPoolLiquidity) {
      obj.initial_pool_liquidity = message.initialPoolLiquidity.map(function (e) {
    ...
    if (message.scalingFactors) {
      obj.scaling_factors = message.scalingFactors.map(function (e) {
        return e;
      });
    } else {
      obj.scaling_factors = [];
