...
var QueryPoolResponse = {
  ...
  toJSON: function toJSON(message) {
    var obj = {};
    message.pool !== undefined && (obj.pool = message.pool ? _any.Any.toJSON(message.pool) : undefined);
    return obj;
  },
  fromPartial: function fromPartial(object) {
    var message = createBaseQueryPoolResponse();
...
var QueryNumPoolsResponse = {
  ...
  toJSON: function toJSON(message) {
    var obj = {};
    message.numPools !== undefined && (obj.numPools = (message.numPools || _helpers.Long.UZERO).toString());
    return obj;
  },
  fromPartial: function fromPartial(object) {
    var message = createBaseQueryNumPoolsResponse();
...
var QueryCalcJoinPoolSharesRequest = {
  ...
  toJSON: function toJSON(message) {
    ...
    message.poolId !== undefined && (obj.poolId = (message.poolId || _helpers.Long.UZERO).toString());
    if (message.tokensIn) {
      obj.tokensIn = message.tokensIn.map(function (e) {
  ...
  fromAmino: function fromAmino(object) {
    return {
      poolId: _helpers.Long.fromString(object.pool_id),
      tokensIn: Array.isArray(object === null || object === void 0 ? void 0 : object.tokens_in) ? object.tokens_in.map(function (e) {
  ...
  toAmino: function toAmino(message) {
    ...
    obj.pool_id = message.poolId ? message.poolId.toString() : undefined;
    if (message.tokensIn) {
      obj.tokens_in = message.tokensIn.map(function (e) {
...
var QueryCalcJoinPoolSharesResponse = {
  ...
  toJSON: function toJSON(message) {
    ...
    if (message.tokensOut) {
      obj.tokensOut = message.tokensOut.map(function (e) {
        return e ? _coin.Coin.toJSON(e) : undefined;
      });
    } else {
      obj.tokensOut = [];
  ...
  fromAmino: function fromAmino(object) {
    return {
      ...
      tokensOut: Array.isArray(object === null || object === void 0 ? void 0 : object.tokens_out) ? object.tokens_out.map(function (e) {
        return _coin.Coin.fromAmino(e);
      }) : []
    };
  },
  toAmino: function toAmino(message) {
    ...
    if (message.tokensOut) {
      obj.tokens_out = message.tokensOut.map(function (e) {
        return e ? _coin.Coin.toAmino(e) : undefined;
      });
    } else {
      obj.tokens_out = [];
...
var QueryPoolParamsResponse = {
  ...
  toJSON: function toJSON(message) {
    var obj = {};
    message.params !== undefined && (obj.params = message.params ? _any.Any.toJSON(message.params) : undefined);
    return obj;
  },
  fromPartial: function fromPartial(object) {
    var message = createBaseQueryPoolParamsResponse();
  ...
  fromAmino: function fromAmino(object) {
    return {
      params: object !== null && object !== void 0 && object.params ? _any.Any.fromAmino(object.params) : undefined
    };
  },
  toAmino: function toAmino(message) {
    var obj = {};
    obj.params = message.params ? _any.Any.toAmino(message.params) : undefined;
    return obj;
  }
};
...
var QueryTotalSharesResponse = {
  ...
  toJSON: function toJSON(message) {
    var obj = {};
    message.totalShares !== undefined && (obj.totalShares = message.totalShares ? _coin.Coin.toJSON(message.totalShares) : undefined);
    return obj;
  },
  fromPartial: function fromPartial(object) {
    var message = createBaseQueryTotalSharesResponse();
...
var QueryPoolsWithFilterRequest = {
  encode: function encode(message) {
    var writer = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _m0.Writer.create();
    var _iterator8 = _createForOfIteratorHelper(message.minLiquidity),
      _step8;
    try {
  ...
  decode: function decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.minLiquidity.push(_coin.Coin.decode(reader, reader.uint32()));
          break;
        case 2:
          message.poolType = reader.string();
          break;
  ...
  fromJSON: function fromJSON(object) {
    return {
      minLiquidity: Array.isArray(object === null || object === void 0 ? void 0 : object.minLiquidity) ? object.minLiquidity.map(function (e) {
        return _coin.Coin.fromJSON(e);
      }) : [],
      poolType: (0, _helpers.isSet)(object.poolType) ? String(object.poolType) : "",
      pagination: (0, _helpers.isSet)(object.pagination) ? _pagination.PageRequest.fromJSON(object.pagination) : undefined
  ...
  toJSON: function toJSON(message) {
    ...
    if (message.minLiquidity) {
      obj.minLiquidity = message.minLiquidity.map(function (e) {
        return e ? _coin.Coin.toJSON(e) : undefined;
      });
    } else {
      obj.minLiquidity = [];
  ...
  fromPartial: function fromPartial(object) {
    ...
    var message = createBaseQueryPoolsWithFilterRequest();
    message.minLiquidity = ((_object$minLiquidity = object.minLiquidity) === null || _object$minLiquidity === void 0 ? void 0 : _object$minLiquidity.map(function (e) {
      return _coin.Coin.fromPartial(e);
    })) || [];
  ...
  fromAmino: function fromAmino(object) {
    return {
      minLiquidity: Array.isArray(object === null || object === void 0 ? void 0 : object.min_liquidity) ? object.min_liquidity.map(function (e) {
        return _coin.Coin.fromAmino(e);
      }) : [],
      poolType: object.pool_type,
      pagination: object !== null && object !== void 0 && object.pagination ? _pagination.PageRequest.fromAmino(object.pagination) : undefined
  ...
  toAmino: function toAmino(message) {
    var obj = {};
    if (message.minLiquidity) {
      obj.min_liquidity = message.minLiquidity.map(function (e) {
        return e ? _coin.Coin.toAmino(e) : undefined;
      });
    } else {
      obj.min_liquidity = [];
...
var QueryPoolsWithFilterResponse = {
  encode: function encode(message) {
    var writer = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _m0.Writer.create();
    var _iterator9 = _createForOfIteratorHelper(message.pools),
      _step9;
    try {
...
var QuerySwapExactAmountInRequest = {
  encode: function encode(message) {
    ...
    try {
      for (_iterator10.s(); !(_step10 = _iterator10.n()).done;) {
        var v = _step10.value;
        _tx.SwapAmountInRoute.encode(v, writer.uint32(34).fork()).ldelim();
      }
    } catch (err) {
      _iterator10.e(err);
    } finally {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          break;
        case 4:
          message.routes.push(_tx.SwapAmountInRoute.decode(reader, reader.uint32()));
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromJSON: function fromJSON(object) {
    return {
      ...
      routes: Array.isArray(object === null || object === void 0 ? void 0 : object.routes) ? object.routes.map(function (e) {
        return _tx.SwapAmountInRoute.fromJSON(e);
      }) : []
    };
  },
  toJSON: function toJSON(message) {
    ...
    if (message.routes) {
      obj.routes = message.routes.map(function (e) {
        return e ? _tx.SwapAmountInRoute.toJSON(e) : undefined;
      });
    } else {
      obj.routes = [];
    }
  ...
  fromPartial: function fromPartial(object) {
    ...
    message.routes = ((_object$routes = object.routes) === null || _object$routes === void 0 ? void 0 : _object$routes.map(function (e) {
      return _tx.SwapAmountInRoute.fromPartial(e);
    })) || [];
    return message;
  },
  fromAmino: function fromAmino(object) {
    return {
      ...
      routes: Array.isArray(object === null || object === void 0 ? void 0 : object.routes) ? object.routes.map(function (e) {
        return _tx.SwapAmountInRoute.fromAmino(e);
      }) : []
    };
  },
  toAmino: function toAmino(message) {
    ...
    if (message.routes) {
      obj.routes = message.routes.map(function (e) {
        return e ? _tx.SwapAmountInRoute.toAmino(e) : undefined;
      });
    } else {
      obj.routes = [];
    }
...
var QuerySwapExactAmountOutRequest = {
  encode: function encode(message) {
    ...
    var _iterator11 = _createForOfIteratorHelper(message.routes),
      _step11;
    try {
      for (_iterator11.s(); !(_step11 = _iterator11.n()).done;) {
        var v = _step11.value;
        _tx.SwapAmountOutRoute.encode(v, writer.uint32(26).fork()).ldelim();
      }
    } catch (err) {
      _iterator11.e(err);
    } finally {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.routes.push(_tx.SwapAmountOutRoute.decode(reader, reader.uint32()));
          break;
        case 4:
  ...
  fromJSON: function fromJSON(object) {
    return {
      ...
      poolId: (0, _helpers.isSet)(object.poolId) ? _helpers.Long.fromValue(object.poolId) : _helpers.Long.UZERO,
      routes: Array.isArray(object === null || object === void 0 ? void 0 : object.routes) ? object.routes.map(function (e) {
        return _tx.SwapAmountOutRoute.fromJSON(e);
      }) : [],
  ...
  toJSON: function toJSON(message) {
    ...
    if (message.routes) {
      obj.routes = message.routes.map(function (e) {
        return e ? _tx.SwapAmountOutRoute.toJSON(e) : undefined;
      });
    } else {
      obj.routes = [];
    }
  ...
  fromPartial: function fromPartial(object) {
    ...
    message.routes = ((_object$routes2 = object.routes) === null || _object$routes2 === void 0 ? void 0 : _object$routes2.map(function (e) {
      return _tx.SwapAmountOutRoute.fromPartial(e);
    })) || [];
  ...
  fromAmino: function fromAmino(object) {
    return {
      ...
      poolId: _helpers.Long.fromString(object.pool_id),
      routes: Array.isArray(object === null || object === void 0 ? void 0 : object.routes) ? object.routes.map(function (e) {
        return _tx.SwapAmountOutRoute.fromAmino(e);
      }) : [],
  ...
  toAmino: function toAmino(message) {
    ...
    if (message.routes) {
      obj.routes = message.routes.map(function (e) {
        return e ? _tx.SwapAmountOutRoute.toAmino(e) : undefined;
      });
    } else {
      obj.routes = [];
    }
...
var QueryTotalLiquidityResponse = {
  encode: function encode(message) {
    var writer = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _m0.Writer.create();
    var _iterator12 = _createForOfIteratorHelper(message.liquidity),
      _step12;
    try {
  ...
  switch (content.type) {
    case "osmosis/gamm/BalancerPool":
      return _any.Any.fromPartial({
        ...
        value: _balancerPool.Pool.encode(_balancerPool.Pool.fromPartial(content.value)).finish()
      });
    case "osmosis/gamm/StableswapPool":
      return _any.Any.fromPartial({
        typeUrl: "/osmosis.gamm.poolmodels.stableswap.v1beta1.Pool",
        value: _stableswap_pool.Pool.encode(_stableswap_pool.Pool.fromPartial(content.value)).finish()
      });
    default:
