...
var MsgJoinPool = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      ...
      tokenInMaxs: Array.isArray(object === null || object === void 0 ? void 0 : object.tokenInMaxs) ? object.tokenInMaxs.map(function (e) {
  ...
  toJSON: function toJSON(message) {
    ...
    if (message.tokenInMaxs) {
      obj.tokenInMaxs = message.tokenInMaxs.map(function (e) {
  ...
  fromAmino: function fromAmino(object) {
    return {
      ...
      tokenInMaxs: Array.isArray(object === null || object === void 0 ? void 0 : object.token_in_maxs) ? object.token_in_maxs.map(function (e) {
  ...
  toAmino: function toAmino(message) {
    ...
    if (message.tokenInMaxs) {
      obj.token_in_maxs = message.tokenInMaxs.map(function (e) {
...
var MsgJoinPoolResponse = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      shareOutAmount: (0, _helpers.isSet)(object.shareOutAmount) ? String(object.shareOutAmount) : "",
      tokenIn: Array.isArray(object === null || object === void 0 ? void 0 : object.tokenIn) ? object.tokenIn.map(function (e) {
        return _coin.Coin.fromJSON(e);
      }) : []
    };
  },
  toJSON: function toJSON(message) {
    ...
    message.shareOutAmount !== undefined && (obj.shareOutAmount = message.shareOutAmount);
    if (message.tokenIn) {
      obj.tokenIn = message.tokenIn.map(function (e) {
        return e ? _coin.Coin.toJSON(e) : undefined;
      });
    } else {
      obj.tokenIn = [];
  ...
  fromAmino: function fromAmino(object) {
    return {
      shareOutAmount: object.share_out_amount,
      tokenIn: Array.isArray(object === null || object === void 0 ? void 0 : object.token_in) ? object.token_in.map(function (e) {
        return _coin.Coin.fromAmino(e);
      }) : []
    };
  },
  toAmino: function toAmino(message) {
    ...
    obj.share_out_amount = message.shareOutAmount;
    if (message.tokenIn) {
      obj.token_in = message.tokenIn.map(function (e) {
        return e ? _coin.Coin.toAmino(e) : undefined;
      });
    } else {
      obj.token_in = [];
...
var MsgExitPool = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      ...
      tokenOutMins: Array.isArray(object === null || object === void 0 ? void 0 : object.tokenOutMins) ? object.tokenOutMins.map(function (e) {
        return _coin.Coin.fromJSON(e);
      }) : []
    };
  },
  toJSON: function toJSON(message) {
    ...
    if (message.tokenOutMins) {
      obj.tokenOutMins = message.tokenOutMins.map(function (e) {
        return e ? _coin.Coin.toJSON(e) : undefined;
      });
    } else {
      obj.tokenOutMins = [];
  ...
  fromAmino: function fromAmino(object) {
    return {
      ...
      tokenOutMins: Array.isArray(object === null || object === void 0 ? void 0 : object.token_out_mins) ? object.token_out_mins.map(function (e) {
        return _coin.Coin.fromAmino(e);
      }) : []
    };
  },
  toAmino: function toAmino(message) {
    ...
    if (message.tokenOutMins) {
      obj.token_out_mins = message.tokenOutMins.map(function (e) {
        return e ? _coin.Coin.toAmino(e) : undefined;
      });
    } else {
      obj.token_out_mins = [];
...
var MsgExitPoolResponse = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      tokenOut: Array.isArray(object === null || object === void 0 ? void 0 : object.tokenOut) ? object.tokenOut.map(function (e) {
        return _coin.Coin.fromJSON(e);
      }) : []
    };
  },
  toJSON: function toJSON(message) {
    var obj = {};
    if (message.tokenOut) {
      obj.tokenOut = message.tokenOut.map(function (e) {
        return e ? _coin.Coin.toJSON(e) : undefined;
      });
    } else {
      obj.tokenOut = [];
  ...
  fromAmino: function fromAmino(object) {
    return {
      tokenOut: Array.isArray(object === null || object === void 0 ? void 0 : object.token_out) ? object.token_out.map(function (e) {
        return _coin.Coin.fromAmino(e);
      }) : []
    };
  },
  toAmino: function toAmino(message) {
    var obj = {};
    if (message.tokenOut) {
      obj.token_out = message.tokenOut.map(function (e) {
        return e ? _coin.Coin.toAmino(e) : undefined;
      });
    } else {
      obj.token_out = [];
...
var MsgSwapExactAmountIn = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      ...
      routes: Array.isArray(object === null || object === void 0 ? void 0 : object.routes) ? object.routes.map(function (e) {
        return SwapAmountInRoute.fromJSON(e);
      }) : [],
  ...
  toJSON: function toJSON(message) {
    ...
    if (message.routes) {
      obj.routes = message.routes.map(function (e) {
        return e ? SwapAmountInRoute.toJSON(e) : undefined;
      });
    } else {
      obj.routes = [];
    }
    message.tokenIn !== undefined && (obj.tokenIn = message.tokenIn ? _coin.Coin.toJSON(message.tokenIn) : undefined);
  ...
  fromAmino: function fromAmino(object) {
    return {
      sender: object.sender,
      routes: Array.isArray(object === null || object === void 0 ? void 0 : object.routes) ? object.routes.map(function (e) {
        return SwapAmountInRoute.fromAmino(e);
      }) : [],
      tokenIn: object !== null && object !== void 0 && object.token_in ? _coin.Coin.fromAmino(object.token_in) : undefined,
  ...
  toAmino: function toAmino(message) {
    ...
    if (message.routes) {
      obj.routes = message.routes.map(function (e) {
        return e ? SwapAmountInRoute.toAmino(e) : undefined;
      });
    } else {
      obj.routes = [];
    }
    obj.token_in = message.tokenIn ? _coin.Coin.toAmino(message.tokenIn) : undefined;
...
var MsgSwapExactAmountOut = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      sender: (0, _helpers.isSet)(object.sender) ? String(object.sender) : "",
      routes: Array.isArray(object === null || object === void 0 ? void 0 : object.routes) ? object.routes.map(function (e) {
        return SwapAmountOutRoute.fromJSON(e);
      }) : [],
  ...
  toJSON: function toJSON(message) {
    ...
    if (message.routes) {
      obj.routes = message.routes.map(function (e) {
        return e ? SwapAmountOutRoute.toJSON(e) : undefined;
      });
    } else {
      obj.routes = [];
    }
    message.tokenInMaxAmount !== undefined && (obj.tokenInMaxAmount = message.tokenInMaxAmount);
    message.tokenOut !== undefined && (obj.tokenOut = message.tokenOut ? _coin.Coin.toJSON(message.tokenOut) : undefined);
    return obj;
  },
  fromPartial: function fromPartial(object) {
  ...
  fromAmino: function fromAmino(object) {
    return {
      sender: object.sender,
      routes: Array.isArray(object === null || object === void 0 ? void 0 : object.routes) ? object.routes.map(function (e) {
        return SwapAmountOutRoute.fromAmino(e);
      }) : [],
      tokenInMaxAmount: object.token_in_max_amount,
      tokenOut: object !== null && object !== void 0 && object.token_out ? _coin.Coin.fromAmino(object.token_out) : undefined
    };
  },
  toAmino: function toAmino(message) {
    var obj = {};
    ...
    if (message.routes) {
      obj.routes = message.routes.map(function (e) {
        return e ? SwapAmountOutRoute.toAmino(e) : undefined;
      });
    } else {
      obj.routes = [];
    }
    obj.token_in_max_amount = message.tokenInMaxAmount;
    obj.token_out = message.tokenOut ? _coin.Coin.toAmino(message.tokenOut) : undefined;
    return obj;
  }
};
...
var MsgJoinSwapExternAmountIn = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      ...
      poolId: (0, _helpers.isSet)(object.poolId) ? _helpers.Long.fromValue(object.poolId) : _helpers.Long.UZERO,
      tokenIn: (0, _helpers.isSet)(object.tokenIn) ? _coin.Coin.fromJSON(object.tokenIn) : undefined,
      shareOutMinAmount: (0, _helpers.isSet)(object.shareOutMinAmount) ? String(object.shareOutMinAmount) : ""
    };
  },
  toJSON: function toJSON(message) {
    var obj = {};
...
var MsgExitSwapExternAmountOut = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      ...
      poolId: (0, _helpers.isSet)(object.poolId) ? _helpers.Long.fromValue(object.poolId) : _helpers.Long.UZERO,
      tokenOut: (0, _helpers.isSet)(object.tokenOut) ? _coin.Coin.fromJSON(object.tokenOut) : undefined,
      shareInMaxAmount: (0, _helpers.isSet)(object.shareInMaxAmount) ? String(object.shareInMaxAmount) : ""
    };
  },
  toJSON: function toJSON(message) {
    var obj = {};
