...
var Gauge = {
  encode: function encode(message) {
    ...
    if (message.startTime !== undefined) {
      _timestamp.Timestamp.encode(message.startTime, writer.uint32(42).fork()).ldelim();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          break;
        case 5:
          message.startTime = _timestamp.Timestamp.decode(reader, reader.uint32());
          break;
        case 6:
  ...
  toJSON: function toJSON(message) {
    ...
    message.distributeTo !== undefined && (obj.distributeTo = message.distributeTo ? _lock.QueryCondition.toJSON(message.distributeTo) : undefined);
    if (message.coins) {
    ...
    message.startTime !== undefined && (obj.startTime = (0, _helpers.fromTimestamp)(message.startTime).toISOString());
    message.numEpochsPaidOver !== undefined && (obj.numEpochsPaidOver = (message.numEpochsPaidOver || _helpers.Long.UZERO).toString());
    message.filledEpochs !== undefined && (obj.filledEpochs = (message.filledEpochs || _helpers.Long.UZERO).toString());
    if (message.distributedCoins) {
      obj.distributedCoins = message.distributedCoins.map(function (e) {
        return e ? _coin.Coin.toJSON(e) : undefined;
      });
    } else {
  ...
  fromPartial: function fromPartial(object) {
    var _object$isPerpetual, _object$coins, _object$distributedCo;
    var message = createBaseGauge();
    ...
    message.startTime = object.startTime !== undefined && object.startTime !== null ? _timestamp.Timestamp.fromPartial(object.startTime) : undefined;
  ...
  fromAmino: function fromAmino(object) {
    return {
      ...
      distributeTo: object !== null && object !== void 0 && object.distribute_to ? _lock.QueryCondition.fromAmino(object.distribute_to) : undefined,
      coins: Array.isArray(object === null || object === void 0 ? void 0 : object.coins) ? object.coins.map(function (e) {
      ...
      numEpochsPaidOver: _helpers.Long.fromString(object.num_epochs_paid_over),
      filledEpochs: _helpers.Long.fromString(object.filled_epochs),
      distributedCoins: Array.isArray(object === null || object === void 0 ? void 0 : object.distributed_coins) ? object.distributed_coins.map(function (e) {
        return _coin.Coin.fromAmino(e);
      }) : []
    };
  },
  toAmino: function toAmino(message) {
    ...
    obj.distribute_to = message.distributeTo ? _lock.QueryCondition.toAmino(message.distributeTo) : undefined;
    if (message.coins) {
      obj.coins = message.coins.map(function (e) {
    ...
    if (message.distributedCoins) {
      obj.distributed_coins = message.distributedCoins.map(function (e) {
        return e ? _coin.Coin.toAmino(e) : undefined;
      });
    } else {
