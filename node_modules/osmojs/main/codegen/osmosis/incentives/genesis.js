...
var GenesisState = {
  ...
  toJSON: function toJSON(message) {
    ...
    if (message.gauges) {
      obj.gauges = message.gauges.map(function (e) {
    ...
    message.lastGaugeId !== undefined && (obj.lastGaugeId = (message.lastGaugeId || _helpers.Long.UZERO).toString());
    return obj;
  },
  ...
  fromAmino: function fromAmino(object) {
    return {
      ...
      lastGaugeId: _helpers.Long.fromString(object.last_gauge_id)
    };
  },
