...
exports.UpcomingGaugesResponse = exports.UpcomingGaugesRequest = exports.UpcomingGaugesPerDenomResponse = exports.UpcomingGaugesPerDenomRequest = exports.RewardsEstResponse = exports.RewardsEstRequest = exports.QueryLockableDurationsResponse = exports.QueryLockableDurationsRequest = exports.ModuleToDistributeCoinsResponse = exports.ModuleToDistributeCoinsRequest = exports.GaugesResponse = exports.GaugesRequest = exports.GaugeByIDResponse = exports.GaugeByIDRequest = exports.ActiveGaugesResponse = exports.ActiveGaugesRequest = exports.ActiveGaugesPerDenomResponse = exports.ActiveGaugesPerDenomRequest = void 0;
...
var GaugeByIDResponse = {
  ...
  toJSON: function toJSON(message) {
    var obj = {};
    message.gauge !== undefined && (obj.gauge = message.gauge ? _gauge.Gauge.toJSON(message.gauge) : undefined);
    return obj;
  },
  fromPartial: function fromPartial(object) {
    var message = createBaseGaugeByIDResponse();
  ...
  fromAmino: function fromAmino(object) {
    return {
      gauge: object !== null && object !== void 0 && object.gauge ? _gauge.Gauge.fromAmino(object.gauge) : undefined
    };
  },
  toAmino: function toAmino(message) {
    var obj = {};
    obj.gauge = message.gauge ? _gauge.Gauge.toAmino(message.gauge) : undefined;
    return obj;
  }
};
...
var GaugesResponse = {
  encode: function encode(message) {
    var writer = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _m0.Writer.create();
    var _iterator2 = _createForOfIteratorHelper(message.data),
      _step2;
    try {
  ...
  toJSON: function toJSON(message) {
    ...
    if (message.data) {
      obj.data = message.data.map(function (e) {
        return e ? _gauge.Gauge.toJSON(e) : undefined;
      });
    } else {
      obj.data = [];
    }
...
var UpcomingGaugesPerDenomResponse = {
  encode: function encode(message) {
    var writer = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _m0.Writer.create();
    var _iterator6 = _createForOfIteratorHelper(message.upcomingGauges),
      _step6;
    try {
  ...
  fromJSON: function fromJSON(object) {
    return {
      upcomingGauges: Array.isArray(object === null || object === void 0 ? void 0 : object.upcomingGauges) ? object.upcomingGauges.map(function (e) {
        return _gauge.Gauge.fromJSON(e);
      }) : [],
      pagination: (0, _helpers.isSet)(object.pagination) ? _pagination.PageResponse.fromJSON(object.pagination) : undefined
    };
  ...
  toJSON: function toJSON(message) {
    ...
    if (message.upcomingGauges) {
      obj.upcomingGauges = message.upcomingGauges.map(function (e) {
        return e ? _gauge.Gauge.toJSON(e) : undefined;
      });
    } else {
      obj.upcomingGauges = [];
  ...
  fromAmino: function fromAmino(object) {
    return {
      upcomingGauges: Array.isArray(object === null || object === void 0 ? void 0 : object.upcoming_gauges) ? object.upcoming_gauges.map(function (e) {
        return _gauge.Gauge.fromAmino(e);
      }) : [],
      pagination: object !== null && object !== void 0 && object.pagination ? _pagination.PageResponse.fromAmino(object.pagination) : undefined
    };
  ...
  toAmino: function toAmino(message) {
    var obj = {};
    if (message.upcomingGauges) {
      obj.upcoming_gauges = message.upcomingGauges.map(function (e) {
        return e ? _gauge.Gauge.toAmino(e) : undefined;
      });
    } else {
      obj.upcoming_gauges = [];
...
var RewardsEstRequest = {
  encode: function encode(message) {
    ...
    var _iterator7 = _createForOfIteratorHelper(message.lockIds),
      _step7;
    try {
  ...
  fromJSON: function fromJSON(object) {
    return {
      ...
      lockIds: Array.isArray(object === null || object === void 0 ? void 0 : object.lockIds) ? object.lockIds.map(function (e) {
        return _helpers.Long.fromValue(e);
      }) : [],
      endEpoch: (0, _helpers.isSet)(object.endEpoch) ? _helpers.Long.fromValue(object.endEpoch) : _helpers.Long.ZERO
    };
  },
  toJSON: function toJSON(message) {
    var obj = {};
    ...
    if (message.lockIds) {
      obj.lockIds = message.lockIds.map(function (e) {
        return (e || _helpers.Long.UZERO).toString();
      });
    } else {
      obj.lockIds = [];
    }
    message.endEpoch !== undefined && (obj.endEpoch = (message.endEpoch || _helpers.Long.ZERO).toString());
    return obj;
  },
  fromPartial: function fromPartial(object) {
  ...
  fromAmino: function fromAmino(object) {
    return {
      owner: object.owner,
      lockIds: Array.isArray(object === null || object === void 0 ? void 0 : object.lock_ids) ? object.lock_ids.map(function (e) {
        return e;
      }) : [],
      endEpoch: _helpers.Long.fromString(object.end_epoch)
    };
  },
  toAmino: function toAmino(message) {
    var obj = {};
    ...
    if (message.lockIds) {
      obj.lock_ids = message.lockIds.map(function (e) {
        return e;
      });
    } else {
      obj.lock_ids = [];
...
var RewardsEstResponse = {
  encode: function encode(message) {
    var writer = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _m0.Writer.create();
    var _iterator8 = _createForOfIteratorHelper(message.coins),
      _step8;
    try {
...
var QueryLockableDurationsResponse = {
  encode: function encode(message) {
    var writer = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _m0.Writer.create();
    var _iterator9 = _createForOfIteratorHelper(message.lockableDurations),
      _step9;
    try {
  ...
  toJSON: function toJSON(message) {
    ...
    if (message.lockableDurations) {
      obj.lockableDurations = message.lockableDurations.map(function (e) {
        return e ? _duration.Duration.toJSON(e) : undefined;
      });
    } else {
