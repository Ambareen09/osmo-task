...
exports.SyntheticLock = exports.QueryCondition = exports.PeriodLock = exports.LockQueryTypeSDKType = exports.LockQueryTypeAmino = exports.LockQueryType = void 0;
...
var LockQueryTypeAmino = LockQueryType;
exports.LockQueryTypeAmino = LockQueryTypeAmino;
...
var PeriodLock = {
  encode: function encode(message) {
    ...
    if (message.endTime !== undefined) {
      _timestamp.Timestamp.encode(message.endTime, writer.uint32(34).fork()).ldelim();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          break;
        case 4:
          message.endTime = _timestamp.Timestamp.decode(reader, reader.uint32());
          break;
        case 5:
  ...
  toJSON: function toJSON(message) {
    ...
    message.duration !== undefined && (obj.duration = message.duration ? _duration.Duration.toJSON(message.duration) : undefined);
    message.endTime !== undefined && (obj.endTime = (0, _helpers.fromTimestamp)(message.endTime).toISOString());
    if (message.coins) {
  ...
  fromPartial: function fromPartial(object) {
    ...
    message.endTime = object.endTime !== undefined && object.endTime !== null ? _timestamp.Timestamp.fromPartial(object.endTime) : undefined;
  ...
  fromAmino: function fromAmino(object) {
    return {
      ...
      endTime: object !== null && object !== void 0 && object.end_time ? _timestamp.Timestamp.fromAmino(object.end_time) : undefined,
      coins: Array.isArray(object === null || object === void 0 ? void 0 : object.coins) ? object.coins.map(function (e) {
  ...
  toAmino: function toAmino(message) {
    ...
    obj.end_time = message.endTime ? _timestamp.Timestamp.toAmino(message.endTime) : undefined;
    if (message.coins) {
      obj.coins = message.coins.map(function (e) {
...
var QueryCondition = {
  encode: function encode(message) {
    ...
    if (message.timestamp !== undefined) {
      _timestamp.Timestamp.encode(message.timestamp, writer.uint32(34).fork()).ldelim();
    }
    return writer;
  },
  decode: function decode(input, length) {
  ...
  fromPartial: function fromPartial(object) {
    var _object$lockQueryType, _object$denom;
    var message = createBaseQueryCondition();
  ...
  fromAmino: function fromAmino(object) {
    return {
      lockQueryType: (0, _helpers.isSet)(object.lock_query_type) ? lockQueryTypeFromJSON(object.lock_query_type) : 0,
      denom: object.denom,
      duration: object !== null && object !== void 0 && object.duration ? _duration.Duration.fromAmino(object.duration) : undefined,
...
var SyntheticLock = {
  encode: function encode(message) {
    ...
    if (message.endTime !== undefined) {
      _timestamp.Timestamp.encode(message.endTime, writer.uint32(26).fork()).ldelim();
    }
    if (message.duration !== undefined) {
  ...
  fromAmino: function fromAmino(object) {
    return {
      underlyingLockId: _helpers.Long.fromString(object.underlying_lock_id),
