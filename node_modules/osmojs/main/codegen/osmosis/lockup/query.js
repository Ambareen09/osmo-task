...
var AccountLockedPastTimeRequest = {
  encode: function encode(message) {
    ...
    if (message.timestamp !== undefined) {
      _timestamp.Timestamp.encode(message.timestamp, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },
  decode: function decode(input, length) {
  ...
  toJSON: function toJSON(message) {
    ...
    if (message.locks) {
      obj.locks = message.locks.map(function (e) {
        return e ? _lock.PeriodLock.toJSON(e) : undefined;
      });
    } else {
      obj.locks = [];
    }
...
var AccountLockedPastTimeDenomRequest = {
  ...
  fromPartial: function fromPartial(object) {
    var _object$owner7, _object$denom;
    var message = createBaseAccountLockedPastTimeDenomRequest();
...
var LockedResponse = {
  ...
  toJSON: function toJSON(message) {
    var obj = {};
    message.lock !== undefined && (obj.lock = message.lock ? _lock.PeriodLock.toJSON(message.lock) : undefined);
    return obj;
  },
  fromPartial: function fromPartial(object) {
    var message = createBaseLockedResponse();
