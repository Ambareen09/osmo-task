...
var GenesisState = {
  encode: function encode(message) {
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        var v = _step.value;
        _duration.Duration.encode(v, writer.uint32(18).fork()).ldelim();
      }
    } catch (err) {
      _iterator.e(err);
    } finally {
    ...
    if (message.distrInfo !== undefined) {
      _incentives.DistrInfo.encode(message.distrInfo, writer.uint32(26).fork()).ldelim();
    }
    if (message.poolToGauges !== undefined) {
      _incentives.PoolToGauges.encode(message.poolToGauges, writer.uint32(34).fork()).ldelim();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          break;
        case 4:
          message.poolToGauges = _incentives.PoolToGauges.decode(reader, reader.uint32());
          break;
        default:
  ...
  fromJSON: function fromJSON(object) {
    return {
      ...
      poolToGauges: (0, _helpers.isSet)(object.poolToGauges) ? _incentives.PoolToGauges.fromJSON(object.poolToGauges) : undefined
    };
  },
  toJSON: function toJSON(message) {
    var obj = {};
    message.params !== undefined && (obj.params = message.params ? _incentives.Params.toJSON(message.params) : undefined);
    ...
    message.distrInfo !== undefined && (obj.distrInfo = message.distrInfo ? _incentives.DistrInfo.toJSON(message.distrInfo) : undefined);
    message.poolToGauges !== undefined && (obj.poolToGauges = message.poolToGauges ? _incentives.PoolToGauges.toJSON(message.poolToGauges) : undefined);
    return obj;
  },
  fromPartial: function fromPartial(object) {
    ...
    message.poolToGauges = object.poolToGauges !== undefined && object.poolToGauges !== null ? _incentives.PoolToGauges.fromPartial(object.poolToGauges) : undefined;
    return message;
  },
  fromAmino: function fromAmino(object) {
    return {
      ...
      poolToGauges: object !== null && object !== void 0 && object.pool_to_gauges ? _incentives.PoolToGauges.fromAmino(object.pool_to_gauges) : undefined
    };
  },
  toAmino: function toAmino(message) {
    ...
    obj.pool_to_gauges = message.poolToGauges ? _incentives.PoolToGauges.toAmino(message.poolToGauges) : undefined;
    return obj;
  }
};
