...
var ReplacePoolIncentivesProposal = {
  encode: function encode(message) {
    ...
    var _iterator = _createForOfIteratorHelper(message.records),
      _step;
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        var v = _step.value;
        _incentives.DistrRecord.encode(v, writer.uint32(26).fork()).ldelim();
      }
    } catch (err) {
      _iterator.e(err);
    } finally {
  ...
  decode: function decode(input, length) {
    ...
    var message = createBaseReplacePoolIncentivesProposal();
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.records.push(_incentives.DistrRecord.decode(reader, reader.uint32()));
          break;
        default:
  ...
  fromJSON: function fromJSON(object) {
    return {
      ...
      records: Array.isArray(object === null || object === void 0 ? void 0 : object.records) ? object.records.map(function (e) {
        return _incentives.DistrRecord.fromJSON(e);
      }) : []
    };
  },
  toJSON: function toJSON(message) {
    ...
    if (message.records) {
      obj.records = message.records.map(function (e) {
        return e ? _incentives.DistrRecord.toJSON(e) : undefined;
      });
    } else {
      obj.records = [];
    }
  ...
  fromPartial: function fromPartial(object) {
    ...
    message.records = ((_object$records = object.records) === null || _object$records === void 0 ? void 0 : _object$records.map(function (e) {
      return _incentives.DistrRecord.fromPartial(e);
    })) || [];
    return message;
  },
  fromAmino: function fromAmino(object) {
    return {
      ...
      records: Array.isArray(object === null || object === void 0 ? void 0 : object.records) ? object.records.map(function (e) {
        return _incentives.DistrRecord.fromAmino(e);
      }) : []
    };
  },
  toAmino: function toAmino(message) {
    ...
    if (message.records) {
      obj.records = message.records.map(function (e) {
        return e ? _incentives.DistrRecord.toAmino(e) : undefined;
      });
    } else {
      obj.records = [];
    }
...
exports.ReplacePoolIncentivesProposal = ReplacePoolIncentivesProposal;
...
var UpdatePoolIncentivesProposal = {
  encode: function encode(message) {
    var writer = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _m0.Writer.create();
    if (message.title !== "") {
      writer.uint32(10).string(message.title);
  ...
  decode: function decode(input, length) {
    var reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    var end = length === undefined ? reader.len : reader.pos + length;
    var message = createBaseUpdatePoolIncentivesProposal();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial: function fromPartial(object) {
    ...
    message.records = ((_object$records2 = object.records) === null || _object$records2 === void 0 ? void 0 : _object$records2.map(function (e) {
      return _incentives.DistrRecord.fromPartial(e);
    })) || [];
    return message;
  },
...
exports.UpdatePoolIncentivesProposal = UpdatePoolIncentivesProposal;