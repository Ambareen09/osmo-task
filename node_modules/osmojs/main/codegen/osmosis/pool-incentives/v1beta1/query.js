...
var QueryGaugeIdsResponse = {
  ...
  toJSON: function toJSON(message) {
    ...
    if (message.gaugeIdsWithDuration) {
      obj.gaugeIdsWithDuration = message.gaugeIdsWithDuration.map(function (e) {
        return e ? QueryGaugeIdsResponse_GaugeIdWithDuration.toJSON(e) : undefined;
      });
    } else {
...
var IncentivizedPool = {
  ...
  toJSON: function toJSON(message) {
    var obj = {};
    message.poolId !== undefined && (obj.poolId = (message.poolId || _helpers.Long.UZERO).toString());
    message.lockableDuration !== undefined && (obj.lockableDuration = message.lockableDuration ? _duration.Duration.toJSON(message.lockableDuration) : undefined);
    message.gaugeId !== undefined && (obj.gaugeId = (message.gaugeId || _helpers.Long.UZERO).toString());
    return obj;
  },
  fromPartial: function fromPartial(object) {
...
var QueryIncentivizedPoolsResponse = {
  ...
  toJSON: function toJSON(message) {
    ...
    if (message.incentivizedPools) {
      obj.incentivizedPools = message.incentivizedPools.map(function (e) {
        return e ? IncentivizedPool.toJSON(e) : undefined;
      });
    } else {
