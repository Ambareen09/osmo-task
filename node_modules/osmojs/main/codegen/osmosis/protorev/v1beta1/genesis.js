...
var GenesisState = {
  encode: function encode(message) {
    ...
    var _iterator = _createForOfIteratorHelper(message.tokenPairs),
      _step;
    try {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.tokenPairs.push(_protorev.TokenPairArbRoutes.decode(reader, reader.uint32()));
          break;
        default:
  ...
  fromJSON: function fromJSON(object) {
    return {
      ...
      tokenPairs: Array.isArray(object === null || object === void 0 ? void 0 : object.tokenPairs) ? object.tokenPairs.map(function (e) {
  ...
  toJSON: function toJSON(message) {
    ...
    if (message.tokenPairs) {
      obj.tokenPairs = message.tokenPairs.map(function (e) {
  ...
  fromPartial: function fromPartial(object) {
    ...
    message.tokenPairs = ((_object$tokenPairs = object.tokenPairs) === null || _object$tokenPairs === void 0 ? void 0 : _object$tokenPairs.map(function (e) {
  ...
  fromAmino: function fromAmino(object) {
    return {
      ...
      tokenPairs: Array.isArray(object === null || object === void 0 ? void 0 : object.token_pairs) ? object.token_pairs.map(function (e) {
  ...
  toAmino: function toAmino(message) {
    ...
    if (message.tokenPairs) {
      obj.token_pairs = message.tokenPairs.map(function (e) {
