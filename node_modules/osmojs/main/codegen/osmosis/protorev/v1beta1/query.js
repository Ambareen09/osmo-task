...
var QueryGetProtoRevProfitsByDenomResponse = {
  ...
  toJSON: function toJSON(message) {
    var obj = {};
    message.profit !== undefined && (obj.profit = message.profit ? _coin.Coin.toJSON(message.profit) : undefined);
    return obj;
  },
  fromPartial: function fromPartial(object) {
    var message = createBaseQueryGetProtoRevProfitsByDenomResponse();
  ...
  fromAmino: function fromAmino(object) {
    return {
      profit: object !== null && object !== void 0 && object.profit ? _coin.Coin.fromAmino(object.profit) : undefined
    };
  },
  toAmino: function toAmino(message) {
    var obj = {};
    obj.profit = message.profit ? _coin.Coin.toAmino(message.profit) : undefined;
    return obj;
  }
};
...
var QueryGetProtoRevStatisticsByPoolRequest = {
  encode: function encode(message) {
    var writer = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _m0.Writer.create();
  ...
  decode: function decode(input, length) {
    var reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    var end = length === undefined ? reader.len : reader.pos + length;
    var message = createBaseQueryGetProtoRevStatisticsByPoolRequest();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
exports.QueryGetProtoRevStatisticsByPoolRequest = QueryGetProtoRevStatisticsByPoolRequest;
function createBaseQueryGetProtoRevStatisticsByPoolResponse() {
  return {
    statistics: undefined
  };
}
var QueryGetProtoRevStatisticsByPoolResponse = {
  encode: function encode(message) {
    var writer = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _m0.Writer.create();
    if (message.statistics !== undefined) {
      _protorev.PoolStatistics.encode(message.statistics, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },
  decode: function decode(input, length) {
    var reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    var end = length === undefined ? reader.len : reader.pos + length;
    var message = createBaseQueryGetProtoRevStatisticsByPoolResponse();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          message.statistics = _protorev.PoolStatistics.decode(reader, reader.uint32());
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromJSON: function fromJSON(object) {
    return {
      statistics: (0, _helpers.isSet)(object.statistics) ? _protorev.PoolStatistics.fromJSON(object.statistics) : undefined
    };
  },
  toJSON: function toJSON(message) {
    var obj = {};
    message.statistics !== undefined && (obj.statistics = message.statistics ? _protorev.PoolStatistics.toJSON(message.statistics) : undefined);
    return obj;
  },
  fromPartial: function fromPartial(object) {
    var message = createBaseQueryGetProtoRevStatisticsByPoolResponse();
    message.statistics = object.statistics !== undefined && object.statistics !== null ? _protorev.PoolStatistics.fromPartial(object.statistics) : undefined;
    return message;
  },
  fromAmino: function fromAmino(object) {
    return {
      statistics: object !== null && object !== void 0 && object.statistics ? _protorev.PoolStatistics.fromAmino(object.statistics) : undefined
    };
  },
  toAmino: function toAmino(message) {
    var obj = {};
    obj.statistics = message.statistics ? _protorev.PoolStatistics.toAmino(message.statistics) : undefined;
    return obj;
  }
};
exports.QueryGetProtoRevStatisticsByPoolResponse = QueryGetProtoRevStatisticsByPoolResponse;
function createBaseQueryGetProtoRevAllStatisticsRequest() {
  return {};
}
var QueryGetProtoRevAllStatisticsRequest = {
  encode: function encode(_) {
    var writer = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _m0.Writer.create();
    return writer;
  },
  decode: function decode(input, length) {
    var reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    var end = length === undefined ? reader.len : reader.pos + length;
    var message = createBaseQueryGetProtoRevAllStatisticsRequest();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        default:
...
exports.QueryGetProtoRevAllStatisticsRequest = QueryGetProtoRevAllStatisticsRequest;
function createBaseQueryGetProtoRevAllStatisticsResponse() {
  return {
    statistics: []
  };
}
var QueryGetProtoRevAllStatisticsResponse = {
  encode: function encode(message) {
    var writer = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _m0.Writer.create();
    var _iterator2 = _createForOfIteratorHelper(message.statistics),
      _step2;
    try {
      for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
        var v = _step2.value;
        _protorev.PoolStatistics.encode(v, writer.uint32(10).fork()).ldelim();
      }
    } catch (err) {
      _iterator2.e(err);
    } finally {
  ...
  decode: function decode(input, length) {
    var reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    var end = length === undefined ? reader.len : reader.pos + length;
    var message = createBaseQueryGetProtoRevAllStatisticsResponse();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          message.statistics.push(_protorev.PoolStatistics.decode(reader, reader.uint32()));
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromJSON: function fromJSON(object) {
    return {
      statistics: Array.isArray(object === null || object === void 0 ? void 0 : object.statistics) ? object.statistics.map(function (e) {
        return _protorev.PoolStatistics.fromJSON(e);
      }) : []
    };
  },
  toJSON: function toJSON(message) {
    ...
    if (message.statistics) {
      obj.statistics = message.statistics.map(function (e) {
        return e ? _protorev.PoolStatistics.toJSON(e) : undefined;
      });
    } else {
      obj.statistics = [];
    }
  ...
  fromPartial: function fromPartial(object) {
    ...
    message.statistics = ((_object$statistics = object.statistics) === null || _object$statistics === void 0 ? void 0 : _object$statistics.map(function (e) {
      return _protorev.PoolStatistics.fromPartial(e);
    })) || [];
    return message;
  },
  fromAmino: function fromAmino(object) {
    return {
      statistics: Array.isArray(object === null || object === void 0 ? void 0 : object.statistics) ? object.statistics.map(function (e) {
        return _protorev.PoolStatistics.fromAmino(e);
      }) : []
    };
  },
  toAmino: function toAmino(message) {
    ...
    if (message.statistics) {
      obj.statistics = message.statistics.map(function (e) {
        return e ? _protorev.PoolStatistics.toAmino(e) : undefined;
      });
    } else {
      obj.statistics = [];
    }
...
exports.QueryGetProtoRevAllStatisticsResponse = QueryGetProtoRevAllStatisticsResponse;
...
var QueryGetProtoRevTokenPairArbRoutesResponse = {
  encode: function encode(message) {
    var writer = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _m0.Writer.create();
    var _iterator3 = _createForOfIteratorHelper(message.routes),
      _step3;
    try {
  ...
  toJSON: function toJSON(message) {
    ...
    if (message.routes) {
      obj.routes = message.routes.map(function (e) {
        return e ? _protorev.TokenPairArbRoutes.toJSON(e) : undefined;
      });
    } else {
      obj.routes = [];
    }
