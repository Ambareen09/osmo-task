...
var Node = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      children: Array.isArray(object === null || object === void 0 ? void 0 : object.children) ? object.children.map(function (e) {
        return Child.fromJSON(e);
      }) : []
    };
  },
  toJSON: function toJSON(message) {
    var obj = {};
    if (message.children) {
      obj.children = message.children.map(function (e) {
        return e ? Child.toJSON(e) : undefined;
      });
    } else {
      obj.children = [];
    }
  ...
  toAmino: function toAmino(message) {
    ...
    if (message.children) {
      obj.children = message.children.map(function (e) {
        return e ? Child.toAmino(e) : undefined;
      });
    } else {
      obj.children = [];
    }
...
var Child = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      index: (0, _helpers.isSet)(object.index) ? (0, _helpers.bytesFromBase64)(object.index) : new Uint8Array(),
      accumulation: (0, _helpers.isSet)(object.accumulation) ? String(object.accumulation) : ""
    };
  },
  toJSON: function toJSON(message) {
    var obj = {};
    message.index !== undefined && (obj.index = (0, _helpers.base64FromBytes)(message.index !== undefined ? message.index : new Uint8Array()));
...
var Leaf = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      leaf: (0, _helpers.isSet)(object.leaf) ? Child.fromJSON(object.leaf) : undefined
    };
  },
  toJSON: function toJSON(message) {
    var obj = {};
