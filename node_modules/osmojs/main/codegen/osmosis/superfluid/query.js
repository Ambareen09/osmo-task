...
var AssetTypeResponse = {
  ...
  toJSON: function toJSON(message) {
    var obj = {};
    message.assetType !== undefined && (obj.assetType = (0, _superfluid.superfluidAssetTypeToJSON)(message.assetType));
    return obj;
  },
  fromPartial: function fromPartial(object) {
...
var AssetMultiplierResponse = {
  ...
  toJSON: function toJSON(message) {
    var obj = {};
    message.osmoEquivalentMultiplier !== undefined && (obj.osmoEquivalentMultiplier = message.osmoEquivalentMultiplier ? _superfluid.OsmoEquivalentMultiplierRecord.toJSON(message.osmoEquivalentMultiplier) : undefined);
    return obj;
  },
  fromPartial: function fromPartial(object) {
    var message = createBaseAssetMultiplierResponse();
...
var SuperfluidIntermediaryAccountInfo = {
  ...
  toJSON: function toJSON(message) {
    ...
    message.gaugeId !== undefined && (obj.gaugeId = (message.gaugeId || _helpers.Long.UZERO).toString());
  ...
  toJSON: function toJSON(message) {
    ...
    if (message.accounts) {
      obj.accounts = message.accounts.map(function (e) {
        return e ? SuperfluidIntermediaryAccountInfo.toJSON(e) : undefined;
      });
    } else {
      obj.accounts = [];
    }
...
var ConnectedIntermediaryAccountRequest = {
  ...
  toJSON: function toJSON(message) {
    var obj = {};
    message.lockId !== undefined && (obj.lockId = (message.lockId || _helpers.Long.UZERO).toString());
    return obj;
  },
  fromPartial: function fromPartial(object) {
    var message = createBaseConnectedIntermediaryAccountRequest();
...
var QueryTotalDelegationByValidatorForDenomResponse = {
  ...
  toJSON: function toJSON(message) {
    ...
    if (message.assets) {
      obj.assets = message.assets.map(function (e) {
        return e ? Delegations.toJSON(e) : undefined;
      });
    } else {
      obj.assets = [];
    }
...
var SuperfluidDelegationsByDelegatorResponse = {
  ...
  toJSON: function toJSON(message) {
    ...
    if (message.superfluidDelegationRecords) {
      obj.superfluidDelegationRecords = message.superfluidDelegationRecords.map(function (e) {
        return e ? _superfluid.SuperfluidDelegationRecord.toJSON(e) : undefined;
      });
    } else {
      obj.superfluidDelegationRecords = [];
    }
    if (message.totalDelegatedCoins) {
      obj.totalDelegatedCoins = message.totalDelegatedCoins.map(function (e) {
        return e ? _coin.Coin.toJSON(e) : undefined;
      });
    } else {
      obj.totalDelegatedCoins = [];
    }
    message.totalEquivalentStakedAmount !== undefined && (obj.totalEquivalentStakedAmount = message.totalEquivalentStakedAmount ? _coin.Coin.toJSON(message.totalEquivalentStakedAmount) : undefined);
    return obj;
  },
  fromPartial: function fromPartial(object) {
...
var SuperfluidUndelegationsByDelegatorResponse = {
  ...
  toJSON: function toJSON(message) {
    ...
    if (message.totalUndelegatedCoins) {
      obj.totalUndelegatedCoins = message.totalUndelegatedCoins.map(function (e) {
        return e ? _coin.Coin.toJSON(e) : undefined;
      });
    } else {
    ...
    if (message.syntheticLocks) {
      obj.syntheticLocks = message.syntheticLocks.map(function (e) {
        return e ? _lock.SyntheticLock.toJSON(e) : undefined;
      });
    } else {
      obj.syntheticLocks = [];
    }
...
var QueryTotalDelegationByDelegatorResponse = {
  ...
  toJSON: function toJSON(message) {
    ...
    if (message.delegationResponse) {
      obj.delegationResponse = message.delegationResponse.map(function (e) {
...
var QueryUnpoolWhitelistResponse = {
  ...
  toJSON: function toJSON(message) {
    var obj = {};
    if (message.poolIds) {
      obj.poolIds = message.poolIds.map(function (e) {
