...
var OsmoEquivalentMultiplierRecord = {
  ...
  toJSON: function toJSON(message) {
    var obj = {};
    message.epochNumber !== undefined && (obj.epochNumber = (message.epochNumber || _helpers.Long.ZERO).toString());
    message.denom !== undefined && (obj.denom = message.denom);
...
var SuperfluidDelegationRecord = {
  ...
  toJSON: function toJSON(message) {
    ...
    message.delegationAmount !== undefined && (obj.delegationAmount = message.delegationAmount ? _coin.Coin.toJSON(message.delegationAmount) : undefined);
    message.equivalentStakedAmount !== undefined && (obj.equivalentStakedAmount = message.equivalentStakedAmount ? _coin.Coin.toJSON(message.equivalentStakedAmount) : undefined);
    return obj;
  },
  fromPartial: function fromPartial(object) {
