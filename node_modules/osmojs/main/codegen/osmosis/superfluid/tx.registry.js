...
var _tx = require("./tx");
var registry = [["/osmosis.superfluid.MsgSuperfluidDelegate", _tx.MsgSuperfluidDelegate], ["/osmosis.superfluid.MsgSuperfluidUndelegate", _tx.MsgSuperfluidUndelegate], ["/osmosis.superfluid.MsgSuperfluidUnbondLock", _tx.MsgSuperfluidUnbondLock], ["/osmosis.superfluid.MsgLockAndSuperfluidDelegate", _tx.MsgLockAndSuperfluidDelegate], ["/osmosis.superfluid.MsgUnPoolWhitelistedPool", _tx.MsgUnPoolWhitelistedPool]];
...
var MessageComposer = {
  ...
  toJSON: {
    superfluidDelegate: function superfluidDelegate(value) {
      return {
        typeUrl: "/osmosis.superfluid.MsgSuperfluidDelegate",
        value: _tx.MsgSuperfluidDelegate.toJSON(value)
      };
    },
    superfluidUndelegate: function superfluidUndelegate(value) {
      return {
        typeUrl: "/osmosis.superfluid.MsgSuperfluidUndelegate",
        value: _tx.MsgSuperfluidUndelegate.toJSON(value)
      };
    },
    superfluidUnbondLock: function superfluidUnbondLock(value) {
      return {
        typeUrl: "/osmosis.superfluid.MsgSuperfluidUnbondLock",
        value: _tx.MsgSuperfluidUnbondLock.toJSON(value)
      };
    },
    lockAndSuperfluidDelegate: function lockAndSuperfluidDelegate(value) {
      return {
        typeUrl: "/osmosis.superfluid.MsgLockAndSuperfluidDelegate",
        value: _tx.MsgLockAndSuperfluidDelegate.toJSON(value)
      };
    },
    unPoolWhitelistedPool: function unPoolWhitelistedPool(value) {
      return {
        typeUrl: "/osmosis.superfluid.MsgUnPoolWhitelistedPool",
        value: _tx.MsgUnPoolWhitelistedPool.toJSON(value)
      };
    }
  },
  fromJSON: {
    superfluidDelegate: function superfluidDelegate(value) {
      return {
        typeUrl: "/osmosis.superfluid.MsgSuperfluidDelegate",
        value: _tx.MsgSuperfluidDelegate.fromJSON(value)
      };
    },
    superfluidUndelegate: function superfluidUndelegate(value) {
      return {
        typeUrl: "/osmosis.superfluid.MsgSuperfluidUndelegate",
        value: _tx.MsgSuperfluidUndelegate.fromJSON(value)
      };
    },
    superfluidUnbondLock: function superfluidUnbondLock(value) {
      return {
        typeUrl: "/osmosis.superfluid.MsgSuperfluidUnbondLock",
        value: _tx.MsgSuperfluidUnbondLock.fromJSON(value)
      };
    },
    lockAndSuperfluidDelegate: function lockAndSuperfluidDelegate(value) {
      return {
        typeUrl: "/osmosis.superfluid.MsgLockAndSuperfluidDelegate",
        value: _tx.MsgLockAndSuperfluidDelegate.fromJSON(value)
      };
    },
    unPoolWhitelistedPool: function unPoolWhitelistedPool(value) {
      return {
        typeUrl: "/osmosis.superfluid.MsgUnPoolWhitelistedPool",
        value: _tx.MsgUnPoolWhitelistedPool.fromJSON(value)
      };
    }
  },
  fromPartial: {
