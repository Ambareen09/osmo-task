...
var Params = {
  ...
  toJSON: function toJSON(message) {
    ...
    if (message.poolCreationFee) {
      obj.poolCreationFee = message.poolCreationFee.map(function (e) {
...
function createBaseGenesisState() {
  return {
    nextPoolId: _helpers.Long.UZERO,
    params: undefined
  };
}
var GenesisState = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      nextPoolId: (0, _helpers.isSet)(object.nextPoolId) ? _helpers.Long.fromValue(object.nextPoolId) : _helpers.Long.UZERO,
      params: (0, _helpers.isSet)(object.params) ? Params.fromJSON(object.params) : undefined
    };
  },
  toJSON: function toJSON(message) {
    var obj = {};
    message.nextPoolId !== undefined && (obj.nextPoolId = (message.nextPoolId || _helpers.Long.UZERO).toString());
    message.params !== undefined && (obj.params = message.params ? Params.toJSON(message.params) : undefined);
    return obj;
  },
  fromPartial: function fromPartial(object) {
    var message = createBaseGenesisState();
    message.nextPoolId = object.nextPoolId !== undefined && object.nextPoolId !== null ? _helpers.Long.fromValue(object.nextPoolId) : _helpers.Long.UZERO;
    message.params = object.params !== undefined && object.params !== null ? Params.fromPartial(object.params) : undefined;
    return message;
  },
  fromAmino: function fromAmino(object) {
    return {
      nextPoolId: _helpers.Long.fromString(object.next_pool_id),
