...
var GenesisState = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      ...
      factoryDenoms: Array.isArray(object === null || object === void 0 ? void 0 : object.factoryDenoms) ? object.factoryDenoms.map(function (e) {
        return GenesisDenom.fromJSON(e);
      }) : []
    };
  },
  toJSON: function toJSON(message) {
    ...
    if (message.factoryDenoms) {
      obj.factoryDenoms = message.factoryDenoms.map(function (e) {
        return e ? GenesisDenom.toJSON(e) : undefined;
      });
    } else {
      obj.factoryDenoms = [];
    }
  ...
  fromAmino: function fromAmino(object) {
    return {
      ...
      factoryDenoms: Array.isArray(object === null || object === void 0 ? void 0 : object.factory_denoms) ? object.factory_denoms.map(function (e) {
        return GenesisDenom.fromAmino(e);
      }) : []
    };
  },
  toAmino: function toAmino(message) {
    ...
    if (message.factoryDenoms) {
      obj.factory_denoms = message.factoryDenoms.map(function (e) {
        return e ? GenesisDenom.toAmino(e) : undefined;
      });
    } else {
      obj.factory_denoms = [];
    }
...
var GenesisDenom = {
  ...
  toJSON: function toJSON(message) {
    ...
    message.authorityMetadata !== undefined && (obj.authorityMetadata = message.authorityMetadata ? _authorityMetadata.DenomAuthorityMetadata.toJSON(message.authorityMetadata) : undefined);
    return obj;
  },
  fromPartial: function fromPartial(object) {
    var _object$denom;
