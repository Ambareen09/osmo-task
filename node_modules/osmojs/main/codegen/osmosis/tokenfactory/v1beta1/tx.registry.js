...
var MessageComposer = {
  ...
  toJSON: {
    createDenom: function createDenom(value) {
      return {
        typeUrl: "/osmosis.tokenfactory.v1beta1.MsgCreateDenom",
        value: _tx.MsgCreateDenom.toJSON(value)
      };
    },
    mint: function mint(value) {
      return {
        typeUrl: "/osmosis.tokenfactory.v1beta1.MsgMint",
        value: _tx.MsgMint.toJSON(value)
      };
    },
    burn: function burn(value) {
      return {
        typeUrl: "/osmosis.tokenfactory.v1beta1.MsgBurn",
        value: _tx.MsgBurn.toJSON(value)
      };
    },
    changeAdmin: function changeAdmin(value) {
      return {
        typeUrl: "/osmosis.tokenfactory.v1beta1.MsgChangeAdmin",
        value: _tx.MsgChangeAdmin.toJSON(value)
      };
    },
    setDenomMetadata: function setDenomMetadata(value) {
      return {
        typeUrl: "/osmosis.tokenfactory.v1beta1.MsgSetDenomMetadata",
        value: _tx.MsgSetDenomMetadata.toJSON(value)
      };
    }
  },
  fromJSON: {
