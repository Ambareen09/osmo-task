...
var Params = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      pruneEpochIdentifier: (0, _helpers.isSet)(object.pruneEpochIdentifier) ? String(object.pruneEpochIdentifier) : "",
      recordHistoryKeepPeriod: (0, _helpers.isSet)(object.recordHistoryKeepPeriod) ? _duration.Duration.fromJSON(object.recordHistoryKeepPeriod) : undefined
    };
  },
  toJSON: function toJSON(message) {
    var obj = {};
    message.pruneEpochIdentifier !== undefined && (obj.pruneEpochIdentifier = message.pruneEpochIdentifier);
    message.recordHistoryKeepPeriod !== undefined && (obj.recordHistoryKeepPeriod = message.recordHistoryKeepPeriod ? _duration.Duration.toJSON(message.recordHistoryKeepPeriod) : undefined);
    return obj;
  },
  ...
  fromAmino: function fromAmino(object) {
    return {
      ...
      recordHistoryKeepPeriod: object !== null && object !== void 0 && object.record_history_keep_period ? _duration.Duration.fromAmino(object.record_history_keep_period) : undefined
    };
  },
  toAmino: function toAmino(message) {
    var obj = {};
    obj.prune_epoch_identifier = message.pruneEpochIdentifier;
    obj.record_history_keep_period = message.recordHistoryKeepPeriod ? _duration.Duration.toAmino(message.recordHistoryKeepPeriod) : undefined;
    return obj;
  }
};
...
var GenesisState = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      twaps: Array.isArray(object === null || object === void 0 ? void 0 : object.twaps) ? object.twaps.map(function (e) {
        return _twap_record.TwapRecord.fromJSON(e);
      }) : [],
  ...
  toJSON: function toJSON(message) {
    var obj = {};
    if (message.twaps) {
      obj.twaps = message.twaps.map(function (e) {
        return e ? _twap_record.TwapRecord.toJSON(e) : undefined;
      });
    } else {
      obj.twaps = [];
    }
  ...
  fromAmino: function fromAmino(object) {
    return {
      twaps: Array.isArray(object === null || object === void 0 ? void 0 : object.twaps) ? object.twaps.map(function (e) {
        return _twap_record.TwapRecord.fromAmino(e);
      }) : [],
  ...
  toAmino: function toAmino(message) {
    ...
    if (message.twaps) {
      obj.twaps = message.twaps.map(function (e) {
        return e ? _twap_record.TwapRecord.toAmino(e) : undefined;
      });
    } else {
      obj.twaps = [];
    }
