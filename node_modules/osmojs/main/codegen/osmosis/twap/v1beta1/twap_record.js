...
var TwapRecord = {
  encode: function encode(message) {
    ...
    if (message.time !== undefined) {
      _timestamp.Timestamp.encode(message.time, writer.uint32(42).fork()).ldelim();
    }
    ...
    if (message.lastErrorTime !== undefined) {
      _timestamp.Timestamp.encode(message.lastErrorTime, writer.uint32(90).fork()).ldelim();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 10:
          ...
          break;
        case 11:
          message.lastErrorTime = _timestamp.Timestamp.decode(reader, reader.uint32());
          break;
        default:
  ...
  toJSON: function toJSON(message) {
    ...
    message.lastErrorTime !== undefined && (obj.lastErrorTime = (0, _helpers.fromTimestamp)(message.lastErrorTime).toISOString());
    return obj;
  },
  fromPartial: function fromPartial(object) {
    var _object$asset0Denom, _object$asset1Denom, _object$p0LastSpotPri, _object$p1LastSpotPri, _object$p0ArithmeticT, _object$p1ArithmeticT, _object$geometricTwap;
    var message = createBaseTwapRecord();
    ...
    message.lastErrorTime = object.lastErrorTime !== undefined && object.lastErrorTime !== null ? _timestamp.Timestamp.fromPartial(object.lastErrorTime) : undefined;
    return message;
  },
  fromAmino: function fromAmino(object) {
    return {
      ...
      lastErrorTime: object !== null && object !== void 0 && object.last_error_time ? _timestamp.Timestamp.fromAmino(object.last_error_time) : undefined
    };
  },
  toAmino: function toAmino(message) {
    ...
    obj.last_error_time = message.lastErrorTime ? _timestamp.Timestamp.toAmino(message.lastErrorTime) : undefined;
    return obj;
  }
};
