...
var ValidatorPreference = {
  ...
  decode: function decode(input, length) {
    ...
    var message = createBaseValidatorPreference();
  ...
  fromJSON: function fromJSON(object) {
    return {
      valOperAddress: (0, _helpers.isSet)(object.valOperAddress) ? String(object.valOperAddress) : "",
...
exports.ValidatorPreference = ValidatorPreference;
function createBaseValidatorSetPreferences() {
  return {
    preferences: []
  };
}
var ValidatorSetPreferences = {
  encode: function encode(message) {
    var writer = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _m0.Writer.create();
  ...
  decode: function decode(input, length) {
    var reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    var end = length === undefined ? reader.len : reader.pos + length;
    var message = createBaseValidatorSetPreferences();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 2:
  ...
  fromJSON: function fromJSON(object) {
    return {
      preferences: Array.isArray(object === null || object === void 0 ? void 0 : object.preferences) ? object.preferences.map(function (e) {
        return ValidatorPreference.fromJSON(e);
      }) : []
    };
  },
  toJSON: function toJSON(message) {
    ...
    if (message.preferences) {
      obj.preferences = message.preferences.map(function (e) {
        return e ? ValidatorPreference.toJSON(e) : undefined;
      });
    } else {
      obj.preferences = [];
    }
  ...
  fromPartial: function fromPartial(object) {
    ...
    message.preferences = ((_object$preferences = object.preferences) === null || _object$preferences === void 0 ? void 0 : _object$preferences.map(function (e) {
      return ValidatorPreference.fromPartial(e);
    })) || [];
    return message;
  },
  fromAmino: function fromAmino(object) {
    return {
      preferences: Array.isArray(object === null || object === void 0 ? void 0 : object.preferences) ? object.preferences.map(function (e) {
        return ValidatorPreference.fromAmino(e);
      }) : []
    };
  },
  toAmino: function toAmino(message) {
    ...
    if (message.preferences) {
      obj.preferences = message.preferences.map(function (e) {
        return e ? ValidatorPreference.toAmino(e) : undefined;
      });
    } else {
      obj.preferences = [];
    }
...
exports.ValidatorSetPreferences = ValidatorSetPreferences;