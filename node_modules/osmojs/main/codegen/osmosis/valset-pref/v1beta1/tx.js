...
var MsgSetValidatorSetPreference = {
  ...
  fromJSON: function fromJSON(object) {
    return {
      delegator: (0, _helpers.isSet)(object.delegator) ? String(object.delegator) : "",
...
var MsgDelegateToValidatorSet = {
  ...
  toJSON: function toJSON(message) {
    var obj = {};
    message.delegator !== undefined && (obj.delegator = message.delegator);
    message.coin !== undefined && (obj.coin = message.coin ? _coin.Coin.toJSON(message.coin) : undefined);
    return obj;
  },
  fromPartial: function fromPartial(object) {
