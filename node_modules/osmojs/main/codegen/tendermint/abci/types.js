...
exports.VoteInfo = exports.ValidatorUpdate = exports.Validator = exports.TxResult = exports.Snapshot = exports.ResponseSetOption = exports.ResponseQuery = exports.ResponseOfferSnapshot_ResultSDKType = exports.ResponseOfferSnapshot_ResultAmino = exports.ResponseOfferSnapshot_Result = exports.ResponseOfferSnapshot = exports.ResponseLoadSnapshotChunk = exports.ResponseListSnapshots = exports.ResponseInitChain = exports.ResponseInfo = exports.ResponseFlush = exports.ResponseException = exports.ResponseEndBlock = exports.ResponseEcho = exports.ResponseDeliverTx = exports.ResponseCommit = exports.ResponseCheckTx = exports.ResponseBeginBlock = exports.ResponseApplySnapshotChunk_ResultSDKType = exports.ResponseApplySnapshotChunk_ResultAmino = exports.ResponseApplySnapshotChunk_Result = exports.ResponseApplySnapshotChunk = exports.Response = exports.RequestSetOption = exports.RequestQuery = exports.RequestOfferSnapshot = exports.RequestLoadSnapshotChunk = exports.RequestListSnapshots = exports.RequestInitChain = exports.RequestInfo = exports.RequestFlush = exports.RequestEndBlock = exports.RequestEcho = exports.RequestDeliverTx = exports.RequestCommit = exports.RequestCheckTx = exports.RequestBeginBlock = exports.RequestApplySnapshotChunk = exports.Request = exports.LastCommitInfo = exports.EvidenceTypeSDKType = exports.EvidenceTypeAmino = exports.EvidenceType = exports.Evidence = exports.EventAttribute = exports.Event = exports.ConsensusParams = exports.CheckTxTypeSDKType = exports.CheckTxTypeAmino = exports.CheckTxType = exports.BlockParams = void 0;
...
var CheckTxTypeAmino = CheckTxType;
exports.CheckTxTypeAmino = CheckTxTypeAmino;
...
var ResponseOfferSnapshot_ResultAmino = ResponseOfferSnapshot_Result;
exports.ResponseOfferSnapshot_ResultAmino = ResponseOfferSnapshot_ResultAmino;
...
var ResponseApplySnapshotChunk_ResultAmino = ResponseApplySnapshotChunk_Result;
exports.ResponseApplySnapshotChunk_ResultAmino = ResponseApplySnapshotChunk_ResultAmino;
...
var EvidenceTypeAmino = EvidenceType;
exports.EvidenceTypeAmino = EvidenceTypeAmino;
...
var RequestInfo = {
  ...
  fromAmino: function fromAmino(object) {
    return {
      ...
      blockVersion: _helpers.Long.fromString(object.block_version),
      p2pVersion: _helpers.Long.fromString(object.p2p_version)
    };
  },
  toAmino: function toAmino(message) {
    var obj = {};
...
var RequestInitChain = {
  ...
  fromAmino: function fromAmino(object) {
    return {
      time: object !== null && object !== void 0 && object.time ? _timestamp.Timestamp.fromAmino(object.time) : undefined,
      ...
      initialHeight: _helpers.Long.fromString(object.initial_height)
    };
  },
  toAmino: function toAmino(message) {
    var obj = {};
    obj.time = message.time ? _timestamp.Timestamp.toAmino(message.time) : undefined;
...
var ResponseInfo = {
  ...
  fromAmino: function fromAmino(object) {
    return {
      data: object.data,
      version: object.version,
      appVersion: _helpers.Long.fromString(object.app_version),
      lastBlockHeight: _helpers.Long.fromString(object.last_block_height),
...
var ResponseQuery = {
  ...
  fromAmino: function fromAmino(object) {
    return {
      ...
      log: object.log,
      info: object.info,
      index: _helpers.Long.fromString(object.index),
      key: object.key,
      value: object.value,
...
var ResponseCheckTx = {
  ...
  fromAmino: function fromAmino(object) {
    return {
      ...
      log: object.log,
      info: object.info,
      gasWanted: _helpers.Long.fromString(object.gas_wanted),
      gasUsed: _helpers.Long.fromString(object.gas_used),
      events: Array.isArray(object === null || object === void 0 ? void 0 : object.events) ? object.events.map(function (e) {
        return Event.fromAmino(e);
      }) : [],
      codespace: object.codespace
...
var ResponseCommit = {
  ...
  fromAmino: function fromAmino(object) {
    return {
      data: object.data,
      retainHeight: _helpers.Long.fromString(object.retain_height)
    };
  },
  toAmino: function toAmino(message) {
    var obj = {};
...
var BlockParams = {
  ...
  fromAmino: function fromAmino(object) {
    return {
      maxBytes: _helpers.Long.fromString(object.max_bytes),
      maxGas: _helpers.Long.fromString(object.max_gas)
    };
  },
  toAmino: function toAmino(message) {
    var obj = {};
...
var Validator = {
  ...
  fromAmino: function fromAmino(object) {
    return {
      ...
      power: _helpers.Long.fromString(object.power)
    };
  },
  toAmino: function toAmino(message) {
    var obj = {};
...
var Evidence = {
  ...
  fromAmino: function fromAmino(object) {
    return {
      ...
      height: _helpers.Long.fromString(object.height),
      time: object !== null && object !== void 0 && object.time ? _timestamp.Timestamp.fromAmino(object.time) : undefined,
      totalVotingPower: _helpers.Long.fromString(object.total_voting_power)
    };
  },
  toAmino: function toAmino(message) {
    var obj = {};
