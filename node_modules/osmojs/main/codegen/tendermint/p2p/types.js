...
var ProtocolVersion = {
  ...
  fromAmino: function fromAmino(object) {
    return {
      p2p: _helpers.Long.fromString(object.p2p),
      block: _helpers.Long.fromString(object.block),
      app: _helpers.Long.fromString(object.app)
    };
  },
...
var PeerInfo = {
  ...
  fromAmino: function fromAmino(object) {
    return {
      ...
      lastConnected: object !== null && object !== void 0 && object.last_connected ? _timestamp.Timestamp.fromAmino(object.last_connected) : undefined
    };
  },
  toAmino: function toAmino(message) {
    var obj = {};
    ...
    obj.last_connected = message.lastConnected ? _timestamp.Timestamp.toAmino(message.lastConnected) : undefined;
    return obj;
  }
};
...
var PeerAddressInfo = {
  ...
  fromAmino: function fromAmino(object) {
    return {
      ...
      lastDialSuccess: object !== null && object !== void 0 && object.last_dial_success ? _timestamp.Timestamp.fromAmino(object.last_dial_success) : undefined,
      lastDialFailure: object !== null && object !== void 0 && object.last_dial_failure ? _timestamp.Timestamp.fromAmino(object.last_dial_failure) : undefined,
  ...
  toAmino: function toAmino(message) {
    ...
    obj.last_dial_success = message.lastDialSuccess ? _timestamp.Timestamp.toAmino(message.lastDialSuccess) : undefined;
    obj.last_dial_failure = message.lastDialFailure ? _timestamp.Timestamp.toAmino(message.lastDialFailure) : undefined;
