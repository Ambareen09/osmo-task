...
export const QueryAccountsResponse = {
  ...
  fromAmino(object) {
    return {
      accounts: Array.isArray(object === null || object === void 0 ? void 0 : object.accounts) ? object.accounts.map(e => Cosmos_authAccountI_FromAmino(e)) : [],
...
export const QueryAccountResponse = {
  ...
  fromAmino(object) {
    return {
      account: object !== null && object !== void 0 && object.account ? Cosmos_authAccountI_FromAmino(object.account) : undefined
    };
  },
  toAmino(message) {
    const obj = {};
...
export const QueryModuleAccountsResponse = {
  ...
  fromAmino(object) {
    return {
      accounts: Array.isArray(object === null || object === void 0 ? void 0 : object.accounts) ? object.accounts.map(e => Cosmos_authModuleAccountI_FromAmino(e)) : []
    };
  },
  toAmino(message) {
    const obj = {};
  ...
  switch (content.type) {
    case "cosmos-sdk/BaseAccount":
      return Any.fromPartial({
        ...
        value: BaseAccount.encode(BaseAccount.fromPartial(content.value)).finish()
      });
    default:
  ...
  switch (content.type) {
    case "cosmos-sdk/ModuleAccount":
      return Any.fromPartial({
        ...
        value: ModuleAccount.encode(ModuleAccount.fromPartial(content.value)).finish()
      });
    default:
      return Any.fromAmino(content);
  }
