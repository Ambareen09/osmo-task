...
export const ContractGrant = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.limit = ContractAuthzLimitX_InterfaceDecoder(reader);
          break;
        case 3:
          message.filter = ContractAuthzFilterX_InterfaceDecoder(reader);
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromAmino(object) {
    return {
      ...
      limit: object !== null && object !== void 0 && object.limit ? ContractAuthzLimitX_FromAmino(object.limit) : undefined,
      filter: object !== null && object !== void 0 && object.filter ? ContractAuthzFilterX_FromAmino(object.filter) : undefined
    };
  },
  toAmino(message) {
    const obj = {};
    obj.contract = message.contract;
    obj.limit = message.limit ? ContractAuthzLimitX_ToAmino(message.limit) : undefined;
    obj.filter = message.filter ? ContractAuthzFilterX_ToAmino(message.filter) : undefined;
    return obj;
  }
};
...
export const ContractAuthzLimitX_InterfaceDecoder = input => {
  const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
...
export const ContractAuthzLimitX_FromAmino = content => {
  switch (content.type) {
    case "wasm/MaxCallsLimit":
      return Any.fromPartial({
        typeUrl: "/cosmwasm.wasm.v1.MaxCallsLimit",
        value: MaxCallsLimit.encode(MaxCallsLimit.fromPartial(content.value)).finish()
      });
    case "wasm/MaxFundsLimit":
      return Any.fromPartial({
        typeUrl: "/cosmwasm.wasm.v1.MaxFundsLimit",
        value: MaxFundsLimit.encode(MaxFundsLimit.fromPartial(content.value)).finish()
      });
    case "wasm/CombinedLimit":
      return Any.fromPartial({
        typeUrl: "/cosmwasm.wasm.v1.CombinedLimit",
        value: CombinedLimit.encode(CombinedLimit.fromPartial(content.value)).finish()
      });
    default:
      return Any.fromAmino(content);
  }
};
export const ContractAuthzLimitX_ToAmino = content => {
...
export const ContractAuthzFilterX_InterfaceDecoder = input => {
  const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
  const data = Any.decode(reader, reader.uint32());
  switch (data.typeUrl) {
...
export const ContractAuthzFilterX_FromAmino = content => {
  switch (content.type) {
    case "wasm/AllowAllMessagesFilter":
      return Any.fromPartial({
        typeUrl: "/cosmwasm.wasm.v1.AllowAllMessagesFilter",
        value: AllowAllMessagesFilter.encode(AllowAllMessagesFilter.fromPartial(content.value)).finish()
      });
    case "wasm/AcceptedMessageKeysFilter":
      return Any.fromPartial({
        typeUrl: "/cosmwasm.wasm.v1.AcceptedMessageKeysFilter",
        value: AcceptedMessageKeysFilter.encode(AcceptedMessageKeysFilter.fromPartial(content.value)).finish()
      });
    case "wasm/AcceptedMessagesFilter":
      return Any.fromPartial({
        typeUrl: "/cosmwasm.wasm.v1.AcceptedMessagesFilter",
        value: AcceptedMessagesFilter.encode(AcceptedMessagesFilter.fromPartial(content.value)).finish()
      });
    default:
      return Any.fromAmino(content);
  }
};
export const ContractAuthzFilterX_ToAmino = content => {
  switch (content.typeUrl) {
    case "/cosmwasm.wasm.v1.AllowAllMessagesFilter":
      return {
