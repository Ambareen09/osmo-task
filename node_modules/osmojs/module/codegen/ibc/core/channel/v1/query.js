...
export const QueryPacketAcknowledgementsRequest = {
  ...
  fromJSON(object) {
    return {
      ...
      channelId: isSet(object.channelId) ? String(object.channelId) : "",
      pagination: isSet(object.pagination) ? PageRequest.fromJSON(object.pagination) : undefined,
      packetCommitmentSequences: Array.isArray(object === null || object === void 0 ? void 0 : object.packetCommitmentSequences) ? object.packetCommitmentSequences.map(e => Long.fromValue(e)) : []
    };
  },
  toJSON(message) {
    const obj = {};
  ...
  fromAmino(object) {
    return {
      ...
      channelId: object.channel_id,
      pagination: object !== null && object !== void 0 && object.pagination ? PageRequest.fromAmino(object.pagination) : undefined,
      packetCommitmentSequences: Array.isArray(object === null || object === void 0 ? void 0 : object.packet_commitment_sequences) ? object.packet_commitment_sequences.map(e => e) : []
    };
  },
  toAmino(message) {
    const obj = {};
...
export const QueryUnreceivedPacketsResponse = {
  ...
  fromAmino(object) {
    return {
      sequences: Array.isArray(object === null || object === void 0 ? void 0 : object.sequences) ? object.sequences.map(e => e) : [],
      height: object !== null && object !== void 0 && object.height ? Height.fromAmino(object.height) : undefined
    };
  },
  toAmino(message) {
...
export const QueryUnreceivedAcksRequest = {
  ...
  fromJSON(object) {
    return {
      portId: isSet(object.portId) ? String(object.portId) : "",
      channelId: isSet(object.channelId) ? String(object.channelId) : "",
      packetAckSequences: Array.isArray(object === null || object === void 0 ? void 0 : object.packetAckSequences) ? object.packetAckSequences.map(e => Long.fromValue(e)) : []
    };
  },
  toJSON(message) {
    const obj = {};
  ...
  fromAmino(object) {
    return {
      portId: object.port_id,
      channelId: object.channel_id,
      packetAckSequences: Array.isArray(object === null || object === void 0 ? void 0 : object.packet_ack_sequences) ? object.packet_ack_sequences.map(e => e) : []
    };
  },
  toAmino(message) {
    const obj = {};
