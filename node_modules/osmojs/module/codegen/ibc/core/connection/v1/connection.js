...
export const ConnectionEnd = {
  ...
  fromAmino(object) {
    return {
      ...
      versions: Array.isArray(object === null || object === void 0 ? void 0 : object.versions) ? object.versions.map(e => Version.fromAmino(e)) : [],
      state: isSet(object.state) ? stateFromJSON(object.state) : 0,
...
export const Counterparty = {
  ...
  fromAmino(object) {
    return {
      ...
      prefix: object !== null && object !== void 0 && object.prefix ? MerklePrefix.fromAmino(object.prefix) : undefined
    };
  },
  toAmino(message) {
    const obj = {};
...
export const ClientPaths = {
  ...
  fromAmino(object) {
    return {
      paths: Array.isArray(object === null || object === void 0 ? void 0 : object.paths) ? object.paths.map(e => e) : []
    };
  },
  toAmino(message) {
    const obj = {};
...
export const Version = {
  ...
  fromAmino(object) {
    return {
      ...
      features: Array.isArray(object === null || object === void 0 ? void 0 : object.features) ? object.features.map(e => e) : []
    };
  },
  toAmino(message) {
    const obj = {};
