...
export const EpochInfo = {
  ...
  fromPartial(object) {
    var _object$identifier, _object$epochCounting;
    const message = createBaseEpochInfo();
  ...
  fromAmino(object) {
    return {
      ...
      currentEpochStartTime: object !== null && object !== void 0 && object.current_epoch_start_time ? Timestamp.fromAmino(object.current_epoch_start_time) : undefined,
...
export const GenesisState = {
  ...
  fromAmino(object) {
    return {
      epochs: Array.isArray(object === null || object === void 0 ? void 0 : object.epochs) ? object.epochs.map(e => EpochInfo.fromAmino(e)) : []
    };
  },
  toAmino(message) {
    const obj = {};
