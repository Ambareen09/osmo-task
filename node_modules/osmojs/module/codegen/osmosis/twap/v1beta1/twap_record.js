...
export const TwapRecord = {
  ...
  fromAmino(object) {
    return {
      ...
      time: object !== null && object !== void 0 && object.time ? Timestamp.fromAmino(object.time) : undefined,
      ...
      lastErrorTime: object !== null && object !== void 0 && object.last_error_time ? Timestamp.fromAmino(object.last_error_time) : undefined
    };
  },
  toAmino(message) {
    const obj = {};
