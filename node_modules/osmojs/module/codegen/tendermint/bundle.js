...
(function (_tendermint) {
  const abci = _tendermint.abci = _objectSpread({}, _198);
  const crypto = _tendermint.crypto = _objectSpread(_objectSpread({}, _199), _200);
  let libs;
  (function (_libs) {
    const bits = _libs.bits = _objectSpread({}, _201);
  })(libs || (libs = _tendermint.libs || (_tendermint.libs = {})));
  const p2p = _tendermint.p2p = _objectSpread({}, _202);
  const types = _tendermint.types = _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({}, _203), _204), _205), _206), _207);
  const version = _tendermint.version = _objectSpread({}, _208);
